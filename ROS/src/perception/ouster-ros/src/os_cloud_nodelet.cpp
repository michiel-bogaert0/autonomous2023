...
private:
  ...
  virtual void onInit() override {
    ...
    imu_pub = nh.advertise<sensor_msgs::Imu>("/ugr/car/sensors/lidar/imu", 100);
    ...
    auto lidar_handler = use_ros_time ? &OusterCloud::lidar_handler_ros_time
                                      : &OusterCloud::lidar_handler_sensor_time;

    lidar_packet_sub =
        nh.subscribe<PacketMsg>("lidar_packets", 2048, lidar_handler, this);
    imu_packet_sub = nh.subscribe<PacketMsg>("imu_packets", 100,
                                             &OusterCloud::imu_handler, this);
  }
