/** \file neoapi_featureaccess.hpp
 \brief        This file is part of the NeoAPI &mdash; It was automatically
 generated and contains access to the features of Baumer cameras. Copyright(c)
 by Baumer Optronic GmbH.All rights reserved, please see the provided licence
...
enum class AcquisitionMode {
  Continuous = 0, //!< Frames are captured continuously until stopped with the
                  //!< AcquisitionStop command.
  MultiFrame, //!< The number of frames specified by AcquisitionFrameCount is
              //!< captured.
...
public:
  ...
  */
  CAcquisitionMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CAcquisitionMode object
  */
  CAcquisitionMode(const CAcquisitionMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class AcquisitionStatusSelector {
  AcquisitionActive =
      0, //!< Device is currently doing an acquisition of one or many frames.
  AcquisitionTransfer, //!< Device is currently transferring an acquisition of
                       //!< one or many frames.
  AcquisitionTriggerWait, //!< Device is currently waiting for a trigger for the
                          //!< capture of one or many frames.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CAcquisitionStatusSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CAcquisitionStatusSelector object
  */
  CAcquisitionStatusSelector(const CAcquisitionStatusSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CAcquisitionStatusSelector &
  operator=(const CAcquisitionStatusSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CApertureStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CApertureStatus object
  */
  CApertureStatus(const CApertureStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class AutoFeatureRegionMode {
  Off = 0, //!< All settings of the selected AutoFeature ROI are automatically
           //!< equal to the selected AutoFeatureRegionReference.
  On //!< The settings of the selected AutoFeature ROI are user defined. The
     //!< AutoFeature is useable only if the AutoFeature ROI fits into the
     //!< AutoFeatureRegionReference of the AutoFeature.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CAutoFeatureRegionMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CAutoFeatureRegionMode object
  */
  CAutoFeatureRegionMode(const CAutoFeatureRegionMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CAutoFeatureRegionReference(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CAutoFeatureRegionReference object
  */
  CAutoFeatureRegionReference(const CAutoFeatureRegionReference &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CAutoFeatureRegionReference &
  operator=(const CAutoFeatureRegionReference &object);
  /**
      \brief     Get the current value.
...
enum class AutoFeatureRegionSelector {
  BalanceWhiteAuto =
      0, //!< Selected features will control the region for BalanceWhiteAuto and
         //!< ColorTransformationAuto algorithm.
  BrightnessAuto //!< Selected features will control the region for GainAuto and
                 //!< ExposureAuto algorithm.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CAutoFeatureRegionSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CAutoFeatureRegionSelector object
  */
  CAutoFeatureRegionSelector(const CAutoFeatureRegionSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CAutoFeatureRegionSelector &
  operator=(const CAutoFeatureRegionSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBOPFShift(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class BalanceWhiteAuto {
  ...
  Off, //!< White balancing is user controlled using BalanceRatioSelector and
       //!< BalanceRatio.
  Once //!< White balancing is automatically adjusted once by the device. Once
       //!< it has converged, it automatically returns to the Off state.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBalanceWhiteAuto(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBalanceWhiteAuto object
  */
  CBalanceWhiteAuto(const CBalanceWhiteAuto &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class BalanceWhiteAutoStatus {
  ColorGainsTooHigh =
      0, //!< The BalanceWhiteAuto calculation failed since at least one of the
         //!< calculated color gains exceeds the maximum value.
  ...
  Underrun //!< The BalanceWhiteAuto calculation failed since at least one
           //!< color-channel shows invalid statistic data.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBalanceWhiteAutoStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBalanceWhiteAutoStatus object
  */
  CBalanceWhiteAutoStatus(const CBalanceWhiteAutoStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CBalanceWhiteAutoStatus &
  operator=(const CBalanceWhiteAutoStatus &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBaudrate(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class BinningHorizontalMode {
  Average = 0, //!< The response from the combined cells will be averaged,
               //!< resulting in increased signal/noise ratio.
  Sum //!< The response from the combined cells will be added, resulting in
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBinningHorizontalMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBinningHorizontalMode object
  */
  CBinningHorizontalMode(const CBinningHorizontalMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBinningSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBinningSelector object
  */
  CBinningSelector(const CBinningSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBinningVerticalMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBinningVerticalMode object
  */
  CBinningVerticalMode(const CBinningVerticalMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBlackLevelSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBlackLevelSelector object
  */
  CBlackLevelSelector(const CBlackLevelSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBlackSunSuppression(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBlackSunSuppression object
  */
  CBlackSunSuppression(const CBlackSunSuppression &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBoSequencerEnable(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBoSequencerEnable object
  */
  CBoSequencerEnable(const CBoSequencerEnable &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBoSequencerIOSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBoSequencerIOSelector object
  */
  CBoSequencerIOSelector(const CBoSequencerIOSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class BoSequencerMode {
  ...
  FreeRunningInitTrigger,     //!< The running mode free running init trigger is
                              //!< selected.
  FreeRunningInitTriggerOnce, //!< The running mode free running init trigger
                              //!< once is selected.
  ...
  SingleStepTriggerOnce //!< The running mode single step trigger once is
                        //!< selected.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBoSequencerMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBoSequencerMode object
  */
  CBoSequencerMode(const CBoSequencerMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
*/
class NEOAPI_CPP_DECL CBoSequencerSensorDigitizationTaps
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBoSequencerSensorDigitizationTaps(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CBoSequencerSensorDigitizationTaps(
      const CBoSequencerSensorDigitizationTaps &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CBoSequencerSensorDigitizationTaps object to
     assign. \return     Object reference with the value set.
  */
  const CBoSequencerSensorDigitizationTaps &
  operator=(const CBoSequencerSensorDigitizationTaps &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The BoSequencerSensorDigitizationTaps value to be
     written. \return    The CBoSequencerSensorDigitizationTaps object
  */
  CBoSequencerSensorDigitizationTaps &
  operator=(BoSequencerSensorDigitizationTaps value);
  /**
      \brief     Set the current value.
      \param     value The BoSequencerSensorDigitizationTaps value to be
     written. \return    The CBoSequencerSensorDigitizationTaps object
  */
  CBoSequencerSensorDigitizationTaps &
  Set(BoSequencerSensorDigitizationTaps value);
  /**
      \brief     Get the current value.
      \return    The value as BoSequencerSensorDigitizationTaps
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBoSequencerStart(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBoSequencerStart object
  */
  CBoSequencerStart(const CBoSequencerStart &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class BrightnessAutoPriority {
  ExposureAuto =
      0,   //!< ExposureAuto has highest priority and will be modified first.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBrightnessAutoPriority(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBrightnessAutoPriority object
  */
  CBrightnessAutoPriority(const CBrightnessAutoPriority &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CBrightnessAutoPriority &
  operator=(const CBrightnessAutoPriority &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CBrightnessCorrection(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CBrightnessCorrection object
  */
  CBrightnessCorrection(const CBrightnessCorrection &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
*/
class NEOAPI_CPP_DECL CCalibrationMatrixValueSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CCalibrationMatrixValueSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CCalibrationMatrixValueSelector(
      const CCalibrationMatrixValueSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CCalibrationMatrixValueSelector &
  operator=(const CCalibrationMatrixValueSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  CCalibrationMatrixValueSelector &
  operator=(CalibrationMatrixValueSelector value);
  /**
      \brief     Set the current value.
      \param     value The CalibrationMatrixValueSelector value to be written.
      \return    The CCalibrationMatrixValueSelector object
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CChunkSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class ClConfiguration {
  Base =
      0, //!< Standard base configuration described by the Camera Link standard.
  DualBase, //!< The camera streams the data from multiple taps (that do not fit
            //!< in the standard base configuration) through two Camera Link
            //!< base ports. It is responsibility of the application or frame
            //!< grabber to reconstruct the full image. Only one of the ports
            //!< (fixed) serves as the "master" for serial communication and
            //!< triggering.
  EightyBit, //!< Standard 80-bit configuration with 10 taps of 8 bits or 8 taps
             //!< of 10 bits, as described by the Camera Link standard.
  Full,  //!< Standard full configuration described by the Camera Link standard.
  Medium //!< Standard medium configuration described by the Camera Link
         //!< standard.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CClConfiguration(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CClConfiguration object
  */
  CClConfiguration(const CClConfiguration &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CClTimeSlotsCount(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CClTimeSlotsCount object
  */
  CClTimeSlotsCount(const CClTimeSlotsCount &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class ColorTransformationAuto {
  Continuous =
      0, //!< Color transformation is constantly adjusted by the device.
  Off,   //!< Color transformation is user controlled using the various
         //!< Colortransformation features.
  Once   //!< Color transformation is automatically adjusted once by the device.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CColorTransformationAuto(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CColorTransformationAuto object
  */
  CColorTransformationAuto(const CColorTransformationAuto &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CColorTransformationAuto &
  operator=(const CColorTransformationAuto &object);
  /**
      \brief     Get the current value.
...
enum class ColorTransformationFactoryListSelector {
  OptimizedMatrixFor3000K = 0, //!< ColorTransformationFactoryList is connected
                               //!< to the color temperature of 3000K.
  OptimizedMatrixFor3200K, //!< ColorTransformationFactoryList is connected to
                           //!< the color temperature of 3200K.
  OptimizedMatrixFor5000K, //!< ColorTransformationFactoryList is connected to
                           //!< the color temperature of 5000K.
  OptimizedMatrixFor5600K, //!< ColorTransformationFactoryList is connected to
                           //!< the color temperature of 5600K.
  OptimizedMatrixFor6500K  //!< ColorTransformationFactoryList is connected to
...
*/
class NEOAPI_CPP_DECL CColorTransformationFactoryListSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CColorTransformationFactoryListSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CColorTransformationFactoryListSelector(
      const CColorTransformationFactoryListSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CColorTransformationFactoryListSelector object to
     assign. \return     Object reference with the value set.
  */
  const CColorTransformationFactoryListSelector &
  operator=(const CColorTransformationFactoryListSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The ColorTransformationFactoryListSelector value to be
     written. \return    The CColorTransformationFactoryListSelector object
  */
  CColorTransformationFactoryListSelector &
  operator=(ColorTransformationFactoryListSelector value);
  /**
      \brief     Set the current value.
      \param     value The ColorTransformationFactoryListSelector value to be
     written. \return    The CColorTransformationFactoryListSelector object
  */
  CColorTransformationFactoryListSelector &
  Set(ColorTransformationFactoryListSelector value);
  /**
      \brief     Get the current value.
      \return    The value as ColorTransformationFactoryListSelector
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CColorTransformationSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CColorTransformationSelector object
  */
  CColorTransformationSelector(const CColorTransformationSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CColorTransformationSelector &
  operator=(const CColorTransformationSelector &object);
  /**
      \brief     Get the current value.
...
*/
class NEOAPI_CPP_DECL CColorTransformationValueSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CColorTransformationValueSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CColorTransformationValueSelector(
      const CColorTransformationValueSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CColorTransformationValueSelector &
  operator=(const CColorTransformationValueSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  CColorTransformationValueSelector &
  operator=(ColorTransformationValueSelector value);
  /**
      \brief     Set the current value.
      \param     value The ColorTransformationValueSelector value to be written.
      \return    The CColorTransformationValueSelector object
  */
  CColorTransformationValueSelector &
  Set(ColorTransformationValueSelector value);
  /**
      \brief     Get the current value.
      \return    The value as ColorTransformationValueSelector
  */
...
enum class ComponentSelector {
  Confidence =
      0, //!< The acquisition of confidence map of the acquired image is
         //!< controlled. Confidence data may be binary (0 - invalid) or an
         //!< integer where 0 is invalid and increasing value is increased
         //!< confidence in the data in the corresponding pixel. If floating
         //!< point representation is used the confidence image is normalized to
         //!< the range [0,1], for integer representation the maximum possible
         //!< integer represents maximum confidence.
  Disparity, //!< The acquisition of stereo camera disparity data is controlled.
             //!< Disparity is a more specific range format approximately
             //!< inversely proportional to distance. Disparity is typically
             //!< given in pixel units.
  Infrared,  //!< The acquisition of non-visible infrared light is controlled.
  Intensity, //!< The acquisition of intensity (monochrome or color) of the
             //!< visible reflected light is controlled.
  Multispectral, //!< The acquisition of multiple spectral bands corresponding
                 //!< to various light wavelenghts is controlled.
  PolarizedRaw,  //!< Acquisition of polarized light intensity. The polarizing
                 //!< filters are arranged in a 2-by-2 pattern: 135° and 0° on
                 //!< even lines, 90° and 45° on odd lines. The raw data is
                 //!< unprocessed. AVAILABLE: Always
  Range, //!< The acquisition of range (distance) data is controlled. The data
         //!< produced may be only range (2.5D) or a point cloud giving the 3D
         //!< coordinates depending on the Scan3dControl features.
  Reflectance, //!< The reflected intensity acquired together with Range in a
               //!< Linescan3D sensor acquiring a single linescan profile for
               //!< each exposure of the sensor.
  Scatter,    //!< The acquisition of data measuring how much light is scattered
              //!< around the reflected light. In processing this is used as an
              //!< additional intensity image, often together with the standard
              //!< intensity or reflectance.
  Ultraviolet //!< The acquisition of non-visible ultraviolet light is
              //!< controlled.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CComponentSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CComponentSelector object
  */
  CComponentSelector(const CComponentSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CCounterEventActivation(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CCounterEventActivation object
  */
  CCounterEventActivation(const CCounterEventActivation &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CCounterEventActivation &
  operator=(const CCounterEventActivation &object);
  /**
      \brief     Get the current value.
...
enum class CounterEventSource {
  ...
  AcquisitionTriggerMissed, //!< Counts the number of missed Acquisition Start
                            //!< Trigger.
  ...
  FrameTransferSkipped, //!< Counts when a frame transfer skipped. AVAILABLE:
                        //!< Always
  ...
  TimestampTick, //!< Counts the number of clock ticks of the Timestamp clock.
                 //!< Can be used to create a programmable timer.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CCounterEventSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CCounterEventSource object
  */
  CCounterEventSource(const CCounterEventSource &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class CounterResetActivation {
  AnyEdge = 0, //!< Resets the counter on the Falling or rising Edge of the
               //!< selected signal.
  FallingEdge, //!< Resets the counter on the Falling Edge of the signal.
  LevelHigh,   //!< Resets the counter as long as the selected signal level is
               //!< High.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CCounterResetActivation(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CCounterResetActivation object
  */
  CCounterResetActivation(const CCounterResetActivation &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CCounterResetActivation &
  operator=(const CCounterResetActivation &object);
  /**
      \brief     Get the current value.
...
enum class CounterResetSource {
  ...
  AcquisitionTriggerMissed, //!< Resets with the reception of the missed
                            //!< Acquisition start trigger.
  Action0, //!< Resets on assertions of the chosen action signal (Broadcasted
           //!< signal on the transport layer).
  Action1, //!< Resets on assertions of the chosen action signal (Broadcasted
           //!< signal on the transport layer).
  Action2, //!< Resets on assertions of the chosen action signal (Broadcasted
           //!< signal on the transport layer).
  ...
  CounterTrigger, //!< Resets with the reception of a trigger on the
  ...
  FrameTriggerMissed, //!< Resets with the reception of the missed Frame start
                      //!< trigger.
  ...
  LineTriggerMissed,  //!< Resets with the reception of the missed Line start
                      //!< trigger.
  LinkTrigger0,       //!< Resets on the reception of the chosen Link Trigger
                      //!< (received from the transport layer).
  LinkTrigger1,       //!< Resets on the reception of the chosen Link Trigger
                      //!< (received from the transport layer).
  LinkTrigger2,       //!< Resets on the reception of the chosen Link Trigger
                      //!< (received from the transport layer).
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CCounterResetSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CCounterResetSource object
  */
  CCounterResetSource(const CCounterResetSource &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CCounterSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CCounterSelector object
  */
  CCounterSelector(const CCounterSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CCustomDataConfigurationMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CCustomDataConfigurationMode object
  */
  CCustomDataConfigurationMode(const CCustomDataConfigurationMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CCustomDataConfigurationMode &
  operator=(const CCustomDataConfigurationMode &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDecimationHorizontalMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDecimationHorizontalMode object
  */
  CDecimationHorizontalMode(const CDecimationHorizontalMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDecimationHorizontalMode &
  operator=(const CDecimationHorizontalMode &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDecimationVerticalMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDecimationVerticalMode object
  */
  CDecimationVerticalMode(const CDecimationVerticalMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDecimationVerticalMode &
  operator=(const CDecimationVerticalMode &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDefectPixelListSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDefectPixelListSelector object
  */
  CDefectPixelListSelector(const CDefectPixelListSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDefectPixelListSelector &
  operator=(const CDefectPixelListSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceCharacterSet(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceCharacterSet object
  */
  CDeviceCharacterSet(const CDeviceCharacterSet &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceClockSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceClockSelector object
  */
  CDeviceClockSelector(const CDeviceClockSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class DeviceFrontUARTSource {
  ...
  RS232 //!< Front side UART interface is used as RS232 interface. Optic control
        //!< is not possible.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceFrontUARTSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceFrontUARTSource object
  */
  CDeviceFrontUARTSource(const CDeviceFrontUARTSource &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceLicense(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceLicenseTypeSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceLicenseTypeSelector object
  */
  CDeviceLicenseTypeSelector(const CDeviceLicenseTypeSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceLicenseTypeSelector &
  operator=(const CDeviceLicenseTypeSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceLinkHeartbeatMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceLinkHeartbeatMode object
  */
  CDeviceLinkHeartbeatMode(const CDeviceLinkHeartbeatMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceLinkHeartbeatMode &
  operator=(const CDeviceLinkHeartbeatMode &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceLinkSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceLinkSelector object
  */
  CDeviceLinkSelector(const CDeviceLinkSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceRegistersEndianness(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceRegistersEndianness object
  */
  CDeviceRegistersEndianness(const CDeviceRegistersEndianness &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceRegistersEndianness &
  operator=(const CDeviceRegistersEndianness &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceScanType(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceScanType object
  */
  CDeviceScanType(const CDeviceScanType &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceSensorSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceSensorSelector object
  */
  CDeviceSensorSelector(const CDeviceSensorSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceSensorType(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceSensorType object
  */
  CDeviceSensorType(const CDeviceSensorType &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceSensorVersion(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceSensorVersion object
  */
  CDeviceSensorVersion(const CDeviceSensorVersion &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceSerialPortBaudRate(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceSerialPortBaudRate object
  */
  CDeviceSerialPortBaudRate(const CDeviceSerialPortBaudRate &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceSerialPortBaudRate &
  operator=(const CDeviceSerialPortBaudRate &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceSerialPortSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceSerialPortSelector object
  */
  CDeviceSerialPortSelector(const CDeviceSerialPortSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceSerialPortSelector &
  operator=(const CDeviceSerialPortSelector &object);
  /**
      \brief     Get the current value.
...
*/
class NEOAPI_CPP_DECL CDeviceStreamChannelEndianness
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CDeviceStreamChannelEndianness(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceStreamChannelEndianness object
  */
  CDeviceStreamChannelEndianness(const CDeviceStreamChannelEndianness &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceStreamChannelEndianness &
  operator=(const CDeviceStreamChannelEndianness &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  operator=(DeviceStreamChannelEndianness value);
  /**
      \brief     Set the current value.
      \param     value The DeviceStreamChannelEndianness value to be written.
      \return    The CDeviceStreamChannelEndianness object
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceStreamChannelType(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceStreamChannelType object
  */
  CDeviceStreamChannelType(const CDeviceStreamChannelType &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceStreamChannelType &
  operator=(const CDeviceStreamChannelType &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceTLType(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceTapGeometry(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceTapGeometry object
  */
  CDeviceTapGeometry(const CDeviceTapGeometry &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceTemperatureSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceTemperatureSelector object
  */
  CDeviceTemperatureSelector(const CDeviceTemperatureSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceTemperatureSelector &
  operator=(const CDeviceTemperatureSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceTemperatureStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CDeviceTemperatureStatus object
  */
  CDeviceTemperatureStatus(const CDeviceTemperatureStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CDeviceTemperatureStatus &
  operator=(const CDeviceTemperatureStatus &object);
  /**
      \brief     Get the current value.
...
*/
class NEOAPI_CPP_DECL CDeviceTemperatureStatusTransitionSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CDeviceTemperatureStatusTransitionSelector(CamBase *cam,
                                             const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CDeviceTemperatureStatusTransitionSelector(
      const CDeviceTemperatureStatusTransitionSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CDeviceTemperatureStatusTransitionSelector object
     to assign. \return     Object reference with the value set.
  */
  const CDeviceTemperatureStatusTransitionSelector &
  operator=(const CDeviceTemperatureStatusTransitionSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The DeviceTemperatureStatusTransitionSelector value to be
     written. \return    The CDeviceTemperatureStatusTransitionSelector object
  */
  CDeviceTemperatureStatusTransitionSelector &
  operator=(DeviceTemperatureStatusTransitionSelector value);
  /**
      \brief     Set the current value.
      \param     value The DeviceTemperatureStatusTransitionSelector value to be
     written. \return    The CDeviceTemperatureStatusTransitionSelector object
  */
  CDeviceTemperatureStatusTransitionSelector &
  Set(DeviceTemperatureStatusTransitionSelector value);
  /**
      \brief     Get the current value.
      \return    The value as DeviceTemperatureStatusTransitionSelector
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CDeviceType(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class EventNotification {
  ...
  Once //!< The selected Event notification is enabled for one event then return
       //!< to Off state.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CEventNotification(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CEventNotification object
  */
  CEventNotification(const CEventNotification &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class EventSelector {
  AcquisitionEnd =
      0, //!< Device just completed the Acquisition of one or many Frames.
  AcquisitionError, //!< Device just detected an error during the active
                    //!< Acquisition.
  AcquisitionStart, //!< Device just started the Acquisition of one or many
                    //!< Frames.
  AcquisitionTransferEnd, //!< Device just completed the transfer of one or many
                          //!< Frames.
  AcquisitionTransferStart, //!< Device just started the transfer of one or many
                            //!< Frames.
  AcquisitionTrigger, //!< Device just received a trigger for the Acquisition of
                      //!< one or many Frames.
  AcquisitionTriggerMissed, //!< Device just missed a trigger for the
                            //!< Acquisition of one or many Frames.
  Action1, //!< The event will be generated when an action command has triggered
           //!< an image in the camera.
  ActionLate, //!< The event will be generated when a valid scheduled action
              //!< command is received and is scheduled to be executed at a time
              //!< that is already past.
  Counter0End,   //!< The event will be generated when counter 0 ends counting.
  Counter0Start, //!< The event will be generated when counter 0 starts
                 //!< counting.
  Counter1End,   //!< The event will be generated when counter 1 ends counting.
  Counter1Start, //!< The event will be generated when counter 1 starts
                 //!< counting.
  DeviceTemperatureStatusChanged, //!< The event will be generated when the
                                  //!< status of the internal device temperature
                                  //!< has been changed. AVAILABLE: Always
  Encoder0Restarted, //!< The event will be generated when the Encoder 0
                     //!< restarts moving.
  Encoder0Stopped, //!< The event will be generated when the Encoder 0 stops for
                   //!< longer than EncoderTimeout.
  Encoder1Restarted, //!< The event will be generated when the Encoder 1
                     //!< restarts moving.
  Encoder1Stopped, //!< The event will be generated when the Encoder 1 stops for
                   //!< longer than EncoderTimeout.
  Error, //!< Device just detected an error during the active Acquisition.
  EventDiscarded, //!< The event will be generated when an event had to be
                  //!< discarded in the camera.
  EventLost,      //!< The event will be generated when an event was lost in the
                  //!< camera. AVAILABLE: Always
  ...
  FrameTransferSkipped, //!< The event will be generated when the internal
                        //!< camera buffer is overflowed and an image has been
                        //!< lost. AVAILABLE: Always
  FrameTransferStart,   //!< Device just started the transfer of one Frame.
  FrameTrigger, //!< Device just received a trigger to start the capture of one
                //!< Frame.
  FrameTriggerMissed, //!< Device just missed a trigger to start the capture of
                      //!< one Frame.
  GigEVisionError,    //!< Device just detected an error. AVAILABLE: Always
  GigEVisionHeartbeatTimeOut, //!< The device runs in heartbeat timeout.
                              //!< AVAILABLE: Always
  Line0AnyEdge, //!< The event will be generated when a Falling or Rising Edge
                //!< is detected on the Line 0.
  Line0FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 0.
  Line0RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 0.
  Line1AnyEdge, //!< The event will be generated when a Falling or Rising Edge
                //!< is detected on the Line 1.
  Line1FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 1.
  Line1RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 1.
  Line2FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 2. AVAILABLE: Always
  Line2RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 2. AVAILABLE: Always
  Line3FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 3. AVAILABLE: Always
  Line3RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 3. AVAILABLE: Always
  Line4FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 4. AVAILABLE: Always
  Line4RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 4. AVAILABLE: Always
  Line5FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 5. AVAILABLE: Always
  Line5RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 5. AVAILABLE: Always
  Line6FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 6. AVAILABLE: Always
  Line6RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 6. AVAILABLE: Always
  Line7FallingEdge, //!< The event will be generated when a Falling Edge is
                    //!< detected on the Line 7. AVAILABLE: Always
  Line7RisingEdge,  //!< The event will be generated when a Rising Edge is
                    //!< detected on the Line 7. AVAILABLE: Always
  LineEnd,          //!< Device just completed the capture of one Line.
  LineStart,        //!< Device just started the capture of one Line.
  LineTrigger, //!< Device just received a trigger to start the capture of one
               //!< Line.
  LineTriggerMissed, //!< Device just missed a trigger to start the capture of
                     //!< one Line.
  LinkSpeedChange,   //!< The event will be generated when the link speed has
                     //!< changed.
  LinkTrigger0, //!< The event will be generated when a Rising Edge is detected
                //!< on the LinkTrigger 0.
  LinkTrigger1, //!< The event will be generated when a Rising Edge is detected
                //!< on the LinkTrigger 1.
  PhysicalConnection0Down,  //!< The event will be generated when a Link down at
                            //!< ethernet interface 0 detect.
  PhysicalConnection0Up,    //!< The event will be generated when a Link up at
                            //!< ethernet interface 0 detect.
  PhysicalConnection1Down,  //!< The event will be generated when a Link down at
                            //!< ethernet interface 1 detect.
  PhysicalConnection1Up,    //!< The event will be generated when a Link up at
                            //!< ethernet interface 1 detect.
  PrimaryApplicationSwitch, //!< The event will be generated when a primary
                            //!< application switchover has been granted (GigE
                            //!< Vision Specific).
  PtpServoStatusChanged, //!< The event will be generated when the status of the
                         //!< internal PTP servo has been changed. AVAILABLE:
                         //!< Always.
  PtpStatusChanged,      //!< The event will be generated when the status of the
                    //!< internal PTP state machine has been changed. AVAILABLE:
                    //!< Always.
  ...
  Stream0TransferBlockTrigger, //!< Device just received a trigger to start the
                               //!< transfer of one Block.
  Stream0TransferBurstEnd, //!< Device just completed the transfer of a burst of
                           //!< Blocks.
  Stream0TransferBurstStart, //!< Device just started the transfer of a burst of
                             //!< Blocks.
  Stream0TransferEnd, //!< Device just completed the transfer of one or many
                      //!< Blocks.
  ...
  Stream0TransferStart,    //!< Device just started the transfer of one or many
                           //!< Blocks.
  Test, //!< The test event will be generated when the device receives the
        //!< TestEventGenerate command (EventNotification for the Test event is
        //!< always On).
  ...
  TransferBufferFull,  //!< The event will be generated when no internal camera
                       //!< buffer is available. AVAILABLE: Always
  TransferBufferReady, //!< The event will be generated when an internal camera
                       //!< buffer is available again. AVAILABLE: Always
  TriggerOverlapped,   //!< Trigger Overlapped. AVAILABLE: Always
  TriggerReady,  //!< The event will be generated when the camera is able to
                 //!< process an incoming trigger signal. AVAILABLE: Always
  TriggerSkipped //!< The event will be generated when camera reject an incoming
                 //!< trigger signal. AVAILABLE: Always
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CEventSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class ExposureAuto {
  Continuous = 0, //!< Exposure duration is constantly adapted by the device to
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CExposureAuto(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class ExposureMode {
  ...
  Timed,   //!< Timed exposure. The exposure duration time is set using the
         //!< ExposureTime or ExposureAuto features and the exposure starts with
         //!< the FrameStart or LineStart.
  ...
  TriggerWidth       //!< Uses the width of the current Frame or Line trigger
               //!< signal(s) pulse to control the exposure duration. Note that
               //!< if the Frame or Line TriggerActivation is RisingEdge or
               //!< LevelHigh, the exposure duration will be the time the
               //!< trigger stays High. If TriggerActivation is FallingEdge or
               //!< LevelLow, the exposure time will last as long as the trigger
               //!< stays Low.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CExposureMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CFocalLengthStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CFocalLengthStatus object
  */
  CFocalLengthStatus(const CFocalLengthStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CFocusStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class GainAuto {
  ...
  Once //!< Gain is automatically adjusted once by the device. Once it has
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CGainAuto(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class GainSelector {
  ...
  GreenBlue,    //!< Gain will be applied to the green blue channel. AVAILABLE:
                //!< Always
  GreenRed,     //!< Gain will be applied to the green red channel. AVAILABLE:
                //!< Always
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CGainSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CGevCCP(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
*/
class NEOAPI_CPP_DECL CGevGVCPExtendedStatusCodesSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CGevGVCPExtendedStatusCodesSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CGevGVCPExtendedStatusCodesSelector(
      const CGevGVCPExtendedStatusCodesSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CGevGVCPExtendedStatusCodesSelector object to
     assign. \return     Object reference with the value set.
  */
  const CGevGVCPExtendedStatusCodesSelector &
  operator=(const CGevGVCPExtendedStatusCodesSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The GevGVCPExtendedStatusCodesSelector value to be
     written. \return    The CGevGVCPExtendedStatusCodesSelector object
  */
  CGevGVCPExtendedStatusCodesSelector &
  operator=(GevGVCPExtendedStatusCodesSelector value);
  /**
      \brief     Set the current value.
      \param     value The GevGVCPExtendedStatusCodesSelector value to be
     written. \return    The CGevGVCPExtendedStatusCodesSelector object
  */
  CGevGVCPExtendedStatusCodesSelector &
  Set(GevGVCPExtendedStatusCodesSelector value);
  /**
      \brief     Get the current value.
      \return    The value as GevGVCPExtendedStatusCodesSelector
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CGevIPConfigurationStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CGevIPConfigurationStatus object
  */
  CGevIPConfigurationStatus(const CGevIPConfigurationStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CGevIPConfigurationStatus &
  operator=(const CGevIPConfigurationStatus &object);
  /**
      \brief     Get the current value.
...
enum class GevSupportedOptionSelector {
  ...
  StreamChannel0PacketResendDestination, //!< Stream Channel 0 Packet Resend
                                         //!< Destination
  StreamChannel0UnconditionalStreaming,  //!< Stream Channel 0 Unconditional
                                         //!< Streaming
  ...
  StreamChannel1PacketResendDestination, //!< Stream Channel 1 Packet Resend
                                         //!< Destination
  StreamChannel1UnconditionalStreaming,  //!< Stream Channel 1 Unconditional
                                         //!< Streaming
  ...
  StreamChannel2PacketResendDestination, //!< Stream Channel 2 Packet Resend
                                         //!< Destination
  StreamChannel2UnconditionalStreaming,  //!< Stream Channel 2 Unconditional
                                         //!< Streaming
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CGevSupportedOptionSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CGevSupportedOptionSelector object
  */
  CGevSupportedOptionSelector(const CGevSupportedOptionSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CGevSupportedOptionSelector &
  operator=(const CGevSupportedOptionSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CHDRGainRatioSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CHDRGainRatioSelector object
  */
  CHDRGainRatioSelector(const CHDRGainRatioSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class HDRTonemappingCurvePresetSelector {
  Preset1 = 0, //!< The HDR tone-mapping preset for a steep logarithmic transfer
               //!< curve will be used.
  Preset2,     //!< The HDR tone-mapping preset for a middle steep logarithmic
               //!< transfer curve will be used.
  Preset3 //!< The HDR tone-mapping preset for a slight logarithmic transfer
          //!< curve will be used.
};
...
*/
class NEOAPI_CPP_DECL CHDRTonemappingCurvePresetSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CHDRTonemappingCurvePresetSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CHDRTonemappingCurvePresetSelector(
      const CHDRTonemappingCurvePresetSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CHDRTonemappingCurvePresetSelector object to
     assign. \return     Object reference with the value set.
  */
  const CHDRTonemappingCurvePresetSelector &
  operator=(const CHDRTonemappingCurvePresetSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The HDRTonemappingCurvePresetSelector value to be
     written. \return    The CHDRTonemappingCurvePresetSelector object
  */
  CHDRTonemappingCurvePresetSelector &
  operator=(HDRTonemappingCurvePresetSelector value);
  /**
      \brief     Set the current value.
      \param     value The HDRTonemappingCurvePresetSelector value to be
     written. \return    The CHDRTonemappingCurvePresetSelector object
  */
  CHDRTonemappingCurvePresetSelector &
  Set(HDRTonemappingCurvePresetSelector value);
  /**
      \brief     Get the current value.
      \return    The value as HDRTonemappingCurvePresetSelector
  */
...
enum class ImageCompressionJPEGFormatOption {
  BaselineOptimized =
      0, //!< Provides optimized color and slightly better compression than
         //!< baseline standard by using custom Huffman tables optimized after
         //!< statistical analysis of the image content.
  BaselineStandard, //!< Indicates this is a baseline sequential (single-scan)
                    //!< DCT-based JPEG.
  Lossless, //!< Selects lossless JPEG compression based on a predictive coding
            //!< model.
...
*/
class NEOAPI_CPP_DECL CImageCompressionJPEGFormatOption
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CImageCompressionJPEGFormatOption(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CImageCompressionJPEGFormatOption(
      const CImageCompressionJPEGFormatOption &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CImageCompressionJPEGFormatOption &
  operator=(const CImageCompressionJPEGFormatOption &object);
  /**
      \brief     Get the current value.
  ...
  */
  CImageCompressionJPEGFormatOption &
  operator=(ImageCompressionJPEGFormatOption value);
  /**
      \brief     Set the current value.
      \param     value The ImageCompressionJPEGFormatOption value to be written.
      \return    The CImageCompressionJPEGFormatOption object
  */
  CImageCompressionJPEGFormatOption &
  Set(ImageCompressionJPEGFormatOption value);
  /**
      \brief     Get the current value.
      \return    The value as ImageCompressionJPEGFormatOption
  */
...
enum class ImageCompressionMode {
  ...
  Off //!< Default value. Image compression is disabled. Images are transmitted
      //!< uncompressed.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CImageCompressionMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CImageCompressionMode object
  */
  CImageCompressionMode(const CImageCompressionMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class ImageCompressionRateOption {
  FixBitrate = 0, //!< Output stream follows a constant bit rate. Allows easy
                  //!< bandwidth management on the link.
  FixQuality //!< Output stream has a constant image quality. Can be used when
             //!< image processing algorithms are sensitive to image degradation
             //!< caused by excessive data compression.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CImageCompressionRateOption(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CImageCompressionRateOption object
  */
  CImageCompressionRateOption(const CImageCompressionRateOption &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CImageCompressionRateOption &
  operator=(const CImageCompressionRateOption &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CInterfaceSpeedMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CInterfaceSpeedMode object
  */
  CInterfaceSpeedMode(const CInterfaceSpeedMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class LUTContent {
  Gamma = 0, //!< The LUT Values are calculated in an automatically way related
             //!< to the value of the feature Gamma.
  UserdefinedLUT //!< The LUT is defined and editable with the features LUTIndex
                 //!< and LUTValue.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLUTContent(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLUTSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class LineFormat {
  ...
  OpenSource, //!< The Line is Open Source. AVAILABLE: (LineMode[LineSelector] =
              //!< Output)
  OptoCoupled, //!< The Line is opto-coupled.
  PushPull,    //!< The Line is Push Pull. AVAILABLE: (LineMode[LineSelector] =
               //!< Output)
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLineFormat(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class LineMode {
  Input =
      0, //!< The selected physical line is used to Input an electrical signal.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLineMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLinePWMConfigurationMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CLinePWMConfigurationMode object
  */
  CLinePWMConfigurationMode(const CLinePWMConfigurationMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CLinePWMConfigurationMode &
  operator=(const CLinePWMConfigurationMode &object);
  /**
      \brief     Get the current value.
...
enum class LinePWMMode {
  FixedFrequency = 0, //!< The selected output line generate a fixed frequency
                      //!< of pulses starting with every transition from 0 to 1
                      //!< and stopping with every transition from 1 to 0.
  Off,     //!< The PWM Mode is off. The selected output line acts as a normal
           //!< output.
  OnePulse //!< The selected output line generates one pulse with every
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLinePWMMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class LineSelector {
  CC1 = 0, //!< Index of the Camera Link physical line and associated I/O
           //!< control block to use. This ensures a direct mapping between the
           //!< lines on the frame grabber and on the camera. Applicable to
           //!< CameraLink Product only.
  CC2, //!< Index of the Camera Link physical line and associated I/O control
       //!< block to use. This ensures a direct mapping between the lines on the
       //!< frame grabber and on the camera. Applicable to CameraLink Product
       //!< only.
  ...
  CC4, //!< Index of the Camera Link physical line and associated I/O control
       ...
       //!< frame grabber and on the camera. Applicable to CameraLink Product
       //!< only.
  Line0, //!< Index of the physical line and associated I/O control block to
         //!< use.
  Line1, //!< Index of the physical line and associated I/O control block to
         //!< use.
  Line2, //!< Index of the physical line and associated I/O control block to
         //!< use.
  Line3, //!< Index of the physical line and associated I/O control block to
         //!< use. AVAILABLE: Always
  Line4, //!< Index of the physical line and associated I/O control block to
         //!< use. AVAILABLE: Always
  Line5, //!< Index of the physical line and associated I/O control block to
         //!< use. AVAILABLE: Always
  Line6, //!< Index of the physical line and associated I/O control block to
         //!< use. AVAILABLE: Always
  Line7, //!< Index of the physical line and associated I/O control block to
         //!< use. AVAILABLE: Always
  LinkTrigger0, //!< Index of the virtual line going on the Transport layer to
                //!< use.
  LinkTrigger1, //!< Index of the virtual line going on the Transport layer to
                //!< use.
  LinkTrigger2  //!< Index of the virtual line going on the Transport layer to
                //!< use.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLineSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class LineSource {
  AcquisitionActive =
      0, //!< Device is currently doing an acquisition of one or many Frames.
  AcquisitionTrigger, //!< Device is currently waiting for a trigger for the
                      //!< capture of one or many Frames.
  ...
  FrameTriggerWait, //!< Device is currently waiting for a Frame start trigger.
  Line0, //!< Device is currently waiting for signal of input line 0. AVAILABLE:
         //!< Always
  Line1, //!< Device is currently waiting for signal of input line 10.
         //!< AVAILABLE: Always
  ...
  UserOutput0, //!< The chosen User Output Bit state as defined by its current
               //!< UserOutputValue.
  UserOutput1, //!< The chosen User Output Bit state as defined by its current
               //!< UserOutputValue.
  UserOutput2, //!< The chosen User Output Bit state as defined by its current
               //!< UserOutputValue.
  UserOutput3, //!< The chosen User Output Bit state as defined by its current
               //!< UserOutputValue. AVAILABLE: Always
  UserOutput4  //!< The chosen User Output Bit state as defined by its current
               //!< UserOutputValue. AVAILABLE: Always
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CLineSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CMemoryActivePart(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CMemoryActivePart object
  */
  CMemoryActivePart(const CMemoryActivePart &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class MemoryMode {
  ...
  Burst, //!< The selected memory part will be written and read simultaneously.
         //!< The memory will be read when MemoryPartFilledBlocks are available.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CMemoryMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class MemoryPartIncrementSource {
  ...
  Software   //!< Selects the command MemoryPartIncrementSoftware as source to
             //!< switch the active memory part.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CMemoryPartIncrementSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CMemoryPartIncrementSource object
  */
  CMemoryPartIncrementSource(const CMemoryPartIncrementSource &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CMemoryPartIncrementSource &
  operator=(const CMemoryPartIncrementSource &object);
  /**
      \brief     Get the current value.
...
enum class MemoryPartMode {
  Cyclic = 0, //!< The selected memory part will be written cyclic. The oldest
              //!< image will be overwritten as first.
  Once //!< The selected memory part will be written once without overrun. No
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CMemoryPartMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CMemoryPartMode object
  */
  CMemoryPartMode(const CMemoryPartMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CMemoryPartSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CMemoryPartSelector object
  */
  CMemoryPartSelector(const CMemoryPartSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  COpticControllerSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A COpticControllerSelector object
  */
  COpticControllerSelector(const COpticControllerSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const COpticControllerSelector &
  operator=(const COpticControllerSelector &object);
  /**
      \brief     Get the current value.
...
enum class OpticControllerStatus {
  ...
  NotSupported,   //!< The optic controller is physically connected but not
                  //!< supported.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  COpticControllerStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A COpticControllerStatus object
  */
  COpticControllerStatus(const COpticControllerStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPartialScanEnabled(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPartialScanEnabled object
  */
  CPartialScanEnabled(const CPartialScanEnabled &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPixelFormat(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpClockAccuracy(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPtpClockAccuracy object
  */
  CPtpClockAccuracy(const CPtpClockAccuracy &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpClockOffsetMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPtpClockOffsetMode object
  */
  CPtpClockOffsetMode(const CPtpClockOffsetMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class PtpDriftOffsetMode {
  Add = 0, //!< Drift Offset will be added to cameras internal timestamp
           //!< increment.
  Sub      //!< Drift Offset will be subtracted from cameras internal timestamp
           //!< increment.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpDriftOffsetMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPtpDriftOffsetMode object
  */
  CPtpDriftOffsetMode(const CPtpDriftOffsetMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
 ...
 */
enum class PtpMode {
  Auto = 0, //!< The device uses the IEEE 1588 best master clock algorithm to
            //!< determine which device is master, and which devices are slaves.
  Slave //!< The clock of the device will act as a PTP slave only to align with
        //!< a master device clock.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpServoStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPtpServoStatus object
  */
  CPtpServoStatus(const CPtpServoStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class PtpSyncMessageIntervalStatus {
  Invalid = 0, //!< Sync message interval is not valid. This may result in
               //!< PtpServoStatus instability.
...
*/
class NEOAPI_CPP_DECL CPtpSyncMessageIntervalStatus
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CPtpSyncMessageIntervalStatus(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPtpSyncMessageIntervalStatus object
  */
  CPtpSyncMessageIntervalStatus(const CPtpSyncMessageIntervalStatus &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CPtpSyncMessageIntervalStatus &
  operator=(const CPtpSyncMessageIntervalStatus &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CPtpTimestampOffsetMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CPtpTimestampOffsetMode object
  */
  CPtpTimestampOffsetMode(const CPtpTimestampOffsetMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CPtpTimestampOffsetMode &
  operator=(const CPtpTimestampOffsetMode &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CReadOutBuffering(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CReadOutBuffering object
  */
  CReadOutBuffering(const CReadOutBuffering &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CReadoutMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CRegionAcquisitionMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CRegionAcquisitionMode object
  */
  CRegionAcquisitionMode(const CRegionAcquisitionMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CRegionConfigurationMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CRegionConfigurationMode object
  */
  CRegionConfigurationMode(const CRegionConfigurationMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CRegionConfigurationMode &
  operator=(const CRegionConfigurationMode &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CRegionMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class RegionSelector {
  ...
  Scan3dExtraction0, //!< Selected feature will control the Scan3dExtraction0
                     //!< output Region.
  Scan3dExtraction1, //!< Selected feature will control the Scan3dExtraction1
                     //!< output Region.
  Scan3dExtraction2  //!< Selected feature will control the Scan3dExtraction2
                     //!< output Region.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CRegionSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CRegionSelector object
  */
  CRegionSelector(const CRegionSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CRegionTransferMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CRegionTransferMode object
  */
  CRegionTransferMode(const CRegionTransferMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSIControl(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSensorADDigitization(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSensorADDigitization object
  */
  CSensorADDigitization(const CSensorADDigitization &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSensorDigitizationTaps(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSensorDigitizationTaps object
  */
  CSensorDigitizationTaps(const CSensorDigitizationTaps &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CSensorDigitizationTaps &
  operator=(const CSensorDigitizationTaps &object);
  /**
      \brief     Get the current value.
...
enum class SensorShutterMode {
  Global = 0, //!< The shutter opens and closes at the same time for all pixels.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSensorShutterMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSensorShutterMode object
  */
  CSensorShutterMode(const CSensorShutterMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSensorTaps(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSequencerConfigurationMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSequencerConfigurationMode object
  */
  CSequencerConfigurationMode(const CSequencerConfigurationMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CSequencerConfigurationMode &
  operator=(const CSequencerConfigurationMode &object);
  /**
      \brief     Get the current value.
...
enum class SequencerFeatureSelector {
  CounterDuration = 0, //!< Sets the duration (or number of events) before the
                       //!< CounterEnd event is generated. AVAILABLE: Always
  CounterEventActivation, //!< Selects the Activation mode Event Source signal.
                          //!< AVAILABLE: Always
  CounterEventSource,     //!< Select the events that will be the source to
                          //!< increment the Counter. AVAILABLE: Always
  CounterResetActivation, //!< Selects the Activation mode of the Counter Reset
                          //!< Source signal. AVAILABLE: Always
  CounterResetSource, //!< Selects the signals that will be the source to reset
                      //!< the Counter. AVAILABLE: Always
  ...
  Height,  //!< Height of the image provided by the device (in pixels).
           //!< AVAILABLE: Always
  OffsetX, //!< Horizontal offset from the origin to the region of interest (in
           //!< pixels). AVAILABLE: Always
  OffsetY, //!< Vertical offset from the origin to the region of interest (in
           //!< pixels). AVAILABLE: Always
  TriggerMode,     //!< Controls if the selected trigger is active. AVAILABLE:
                   //!< Always
  UserOutputValue, //!< Sets the value of the bit selected by
                   //!< UserOutputSelector. AVAILABLE: Always
  UserOutputValueAll, //!< It is subject to the UserOutputValueAllMask.
                      //!< AVAILABLE: Always
  Width //!< Width of the image provided by the device (in pixels). AVAILABLE:
        //!< Always
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSequencerFeatureSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSequencerFeatureSelector object
  */
  CSequencerFeatureSelector(const CSequencerFeatureSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CSequencerFeatureSelector &
  operator=(const CSequencerFeatureSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSequencerMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class SequencerTriggerActivation {
  AnyEdge = 0, //!< Specifies that the trigger is considered valid on the
               //!< falling or rising edge of the source signal.
  FallingEdge, //!< Specifies that the trigger is considered valid on the
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSequencerTriggerActivation(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSequencerTriggerActivation object
  */
  CSequencerTriggerActivation(const CSequencerTriggerActivation &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CSequencerTriggerActivation &
  operator=(const CSequencerTriggerActivation &object);
  /**
      \brief     Get the current value.
...
enum class SequencerTriggerSource {
  ...
  AcquisitionTriggerMissed, //!< Starts with the reception of the missed
                            //!< Acquisition Trigger.
  ...
  CC1, //!< Index of the Camera Link physical line and associated I/O control
       //!< block to use. This ensures a direct mapping between the lines on the
       //!< frame grabber and on the camera. Applicable to CameraLink products
       //!< only.
  CC2, //!< Index of the Camera Link physical line and associated I/O control
       //!< block to use. This ensures a direct mapping between the lines on the
       //!< frame grabber and on the camera. Applicable to CameraLink products
  ...
  ExposureActive,  //!< Starts with the reception of the Exposure Active.
                   //!< AVAILABLE: Always
  ...
  FrameTriggerMissed, //!< Starts with the reception of the missed Frame
                      //!< Trigger.
  Line0, //!< Starts when the specified TimerTriggerActivation condition is met
         //!< on the chosen I/O Line.
  Line1, //!< Starts when the specified TimerTriggerActivation condition is met
         //!< on the chosen I/O Line.
  Line2, //!< Starts when the specified TimerTriggerActivation condition is met
         //!< on the chosen I/O Line.
  ...
  ReadOutActive,   //!< Starts with the reception of the Read Out Active.
                   //!< AVAILABLE: Always
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSequencerTriggerSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSequencerTriggerSource object
  */
  CSequencerTriggerSource(const CSequencerTriggerSource &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CSequencerTriggerSource &
  operator=(const CSequencerTriggerSource &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CShadingSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CShadingSelector object
  */
  CShadingSelector(const CShadingSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class SharpeningMode {
  ActiveNoiseReduction =
      0,              //!< Sharpening is enabled in active noise reduction mode
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSharpeningMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSharpeningMode object
  */
  CSharpeningMode(const CSharpeningMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSourceID(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSourceSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSourceSelector object
  */
  CSourceSelector(const CSourceSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CSwitchPortSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CSwitchPortSelector object
  */
  CSwitchPortSelector(const CSwitchPortSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class TestPattern {
  ...
  ColorBar,  //!< Image is filled with stripes of color including White, Black,
             //!< Red, Green, Blue, Cyan, Magenta and Yellow.
  FrameCounter,     //!< A frame counter is superimposed on the live image.
  GreyDiagonalRamp, //!< Image is filled diagonally with an image that goes from
                    //!< the darkest possible value to the brightest. AVAILABLE:
                    //!< Always
  GreyDiagonalRampHorizontalAndVerticalLineMoving, //!< Image is filled
                                                   //!< diagonally with an image
                                                   //!< that goes from the
                                                   //!< darkest possible value
                                                   //!< to the brightest with
                                                   //!< moving horizontal and
                                                   //!< vertical lines.
                                                   //!< AVAILABLE: Always
  GreyDiagonalRampHorizontalLineMoving, //!< Image is filled diagonally with an
                                        //!< image that goes from the darkest
                                        //!< possible value to the brightest
                                        //!< with moving horizontal lines.
                                        //!< AVAILABLE: Always
  GreyDiagonalRampVerticalLineMoving,   //!< Image is filled diagonally with an
                                        //!< image that goes from the darkest
  //!< possible value to the brightest with
  //!< moving vertical lines. AVAILABLE:
  //!< Always
  GreyDiagonalRampWithLineMoving, //!< Image is filled diagonally with an image
                                  //!< that goes from the darkest possible value
                                  //!< to the brightest with moving lines.
                                  //!< AVAILABLE: Always
  GreyHorizontalRamp, //!< Image is filled horizontally with an image that goes
                      //!< from the darkest possible value to the brightest.
  GreyHorizontalRampHorizontalAndVerticalLineMoving, //!< Image is filled
                                                     //!< horizontally with an
                                                     //!< image that goes from
                                                     //!< the darkest possible
                                                     //!< value to the brightest
                                                     //!< with moving horizontal
                                                     //!< and vertical lines.
                                                     //!< AVAILABLE: Always
  GreyHorizontalRampHorizontalLineMoving, //!< Image is filled horizontally with
                                          //!< an image that goes from the
                                          //!< darkest possible value to the
                                          //!< brightest with moving horizontal
                                          //!< lines. AVAILABLE: Always
  GreyHorizontalRampMoving, //!< Image is filled horizontally with an image that
                            //!< goes from the darkest possible value to the
                            //!< brightest and that moves horizontally from left
                            //!< to right at each frame.
  GreyHorizontalRampVerticalLineMoving, //!< Image is filled horizontally with
                                        //!< an image that goes from the darkest
                                        //!< possible value to the brightest
                                        //!< with moving vertical lines.
                                        //!< AVAILABLE: Always
  GreyVerticalRamp, //!< Image is filled vertically with an image that goes from
                    //!< the darkest possible value to the brightest.
  GreyVerticalRampHorizontalAndVerticalLineMoving, //!< Image is filled
                                                   //!< vertically with an image
                                                   //!< that goes from the
                                                   //!< darkest possible value
                                                   //!< to the brightest with
                                                   //!< moving horizontal and
                                                   //!< vertical lines.
                                                   //!< AVAILABLE: Always
  GreyVerticalRampHorizontalLineMoving, //!< Image is filled vertically with an
                                        //!< image that goes from the darkest
                                        //!< possible value to the brightest
                                        //!< with moving horizontal lines.
                                        //!< AVAILABLE: Always
  GreyVerticalRampMoving, //!< Image is filled vertically with an image that
                          //!< goes from the darkest possible value to the
                          //!< brightest and that moves vertically from top to
                          //!< bottom at each frame.
  GreyVerticalRampVerticalLineMoving, //!< Image is filled vertically with an
                                      //!< image that goes from the darkest
                                      //!< possible value to the brightest with
                                      //!< moving vertical lines. AVAILABLE:
                                      //!< Always
  HorizontalAndVerticalLineMoving, //!< Image is filled with moving horizontal
                                   //!< and vertical lines. AVAILABLE: Always
  HorizontalLineMoving, //!< A moving horizontal line is superimposed on the
                        //!< live image.
  Off,                  //!< Image is coming from the sensor.
  VerticalLineMoving,   //!< A moving vertical line is superimposed on the live
                        //!< image.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTestPattern(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class TestPatternGeneratorSelector {
  ImageProcessor = 0, //!< TestPattern feature will control the image processor.
                      //!< AVAILABLE: Always
  Region0, //!< TestPattern feature will control the region 0 test pattern
           //!< generator.
  Region1, //!< TestPattern feature will control the region 1 test pattern
           //!< generator.
  Region2, //!< TestPattern feature will control the region 2 test pattern
           //!< generator.
  Sensor,  //!< TestPattern feature will control the sensor's test pattern
           //!< generator.
  SensorProcessor //!< TestPattern feature will control the sensor processor.
                  //!< AVAILABLE: Always
};
...
*/
class NEOAPI_CPP_DECL CTestPatternGeneratorSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CTestPatternGeneratorSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTestPatternGeneratorSelector object
  */
  CTestPatternGeneratorSelector(const CTestPatternGeneratorSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CTestPatternGeneratorSelector &
  operator=(const CTestPatternGeneratorSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTimerSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class TimerTriggerActivation {
  AnyEdge = 0, //!< Starts counting on the Falling or Rising Edge of the
               //!< selected trigger signal.
  FallingEdge, //!< Starts counting on the Falling Edge of the selected trigger
               //!< signal.
  ...
  RisingEdge   //!< Starts counting on the Rising Edge of the selected trigger
               //!< signal.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTimerTriggerActivation(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTimerTriggerActivation object
  */
  CTimerTriggerActivation(const CTimerTriggerActivation &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CTimerTriggerActivation &
  operator=(const CTimerTriggerActivation &object);
  /**
      \brief     Get the current value.
...
enum class TimerTriggerSource {
  ...
  AcquisitionStart,   //!< Starts with the reception of the Acquisition Start.
  AcquisitionTrigger, //!< Starts with the reception of the Acquisition Trigger.
  AcquisitionTriggerMissed, //!< Starts with the reception of a missed
                            //!< Acquisition Trigger.
  Action0,         //!< Starts with the assertion of the chosen action signal.
  Action1,         //!< Starts with the assertion of the chosen action signal.
  Action2,         //!< Starts with the assertion of the chosen action signal.
  ...
  Software,    //!< Starts when the trigger was generated by the software.
               //!< AVAILABLE: Always
  SoftwareSignal0, //!< Starts on the reception of the Software Signal.
  SoftwareSignal1, //!< Starts on the reception of the Software Signal.
  SoftwareSignal2, //!< Starts on the reception of the Software Signal.
  Timer0End, //!< Starts with the reception of the Timer End. Note that a timer
             //!< can retrigger itself to achieve a free running Timer.
  Timer0Start, //!< Starts with the reception of the Timer Start.
  Timer1End, //!< Starts with the reception of the Timer End. Note that a timer
             //!< can retrigger itself to achieve a free running Timer.
  Timer1Start, //!< Starts with the reception of the Timer Start.
  Timer2End, //!< Starts with the reception of the Timer End. Note that a timer
             //!< can retrigger itself to achieve a free running Timer.
  Timer2Start,    //!< Starts with the reception of the Timer Start.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTimerTriggerSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTimerTriggerSource object
  */
  CTimerTriggerSource(const CTimerTriggerSource &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTransferControlMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTransferControlMode object
  */
  CTransferControlMode(const CTransferControlMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTransferOperationMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTransferOperationMode object
  */
  CTransferOperationMode(const CTransferOperationMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class TransferSelector {
  All =
      0, //!< The transfer features control all the data streams simultaneously.
  ...
  Stream3, //!< The transfer features control the data stream 3, used for memory
           //!< part 3. AVAILABLE: Always
  Stream4  //!< The transfer features control the data stream 4, used for memory
           //!< part 4. AVAILABLE: Always
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTransferSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTransferSelector object
  */
  CTransferSelector(const CTransferSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class TransferStatusSelector {
  ...
  Stopping,      //!< Data blocks transmission is stopping. The current block
                 //!< transmission will be completed and the transfer state will
                 //!< stop.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTransferStatusSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTransferStatusSelector object
  */
  CTransferStatusSelector(const CTransferStatusSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CTransferStatusSelector &
  operator=(const CTransferStatusSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTriggerActivation(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTriggerActivation object
  */
  CTriggerActivation(const CTriggerActivation &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTriggerMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTriggerOverlap(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTriggerOverlap object
  */
  CTriggerOverlap(const CTriggerOverlap &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class TriggerSelector {
  AcquisitionActive =
      0, //!< Selects a trigger that controls the duration of the Acquisition of
         //!< one or many frames. The Acquisition is activated when the trigger
         //!< signal becomes active and terminated when it goes back to the
         //!< inactive state.
  AcquisitionEnd,   //!< Selects a trigger that ends the Acquisition of one or
                    //!< many frames according to AcquisitionMode.
  AcquisitionStart, //!< Selects a trigger that starts the Acquisition of one or
                    //!< many frames according to AcquisitionMode.
  ExposureActive,   //!< Selects a trigger controlling the duration of the
                    //!< exposure of one frame (or Line).
  ExposureEnd, //!< Selects a trigger controlling the end of the exposure of one
               //!< Frame (or Line).
  ExposureStart, //!< Selects a trigger controlling the start of the exposure of
                 //!< one Frame (or Line).
  FrameActive,   //!< Selects a trigger controlling the duration of one frame
                 //!< (mainly used in linescan mode).
  ...
  FrameBurstStart,  //!< Selects a trigger starting the capture of the bursts of
                    //!< frames in an acquisition. AcquisitionBurstFrameCount
  ...
  FrameEnd, //!< Selects a trigger ending the capture of one frame (mainly used
            //!< in linescan mode).
  ...
  LineStart,  //!< Selects a trigger starting the capture of one Line of a Frame
              //!< (mainly used in linescan mode).
  MultiSlopeExposureLimit1 //!< Selects a trigger controlling the first duration
                           //!< of a multi-slope exposure. Exposure is continued
                           //!< according to the pre-defined multi-slope
                           //!< settings.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTriggerSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CTriggerSelector object
  */
  CTriggerSelector(const CTriggerSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class TriggerSource {
  Action0 = 0, //!< Specifies which Action command to use as internal source for
               //!< the trigger.
  Action1, //!< Specifies which Action command to use as internal source for the
           //!< trigger.
  Action2, //!< Specifies which Action command to use as internal source for the
           //!< trigger.
  All,     //!< All trigger sources are active. AVAILABLE: (ExposureMode !=
           //!< TriggerWidth)
  CC1, //!< Index of the Camera Link physical line and associated I/O control
       //!< block to use. This ensures a direct mapping between the lines on the
       //!< frame grabber and on the camera. Applicable to CameraLink products
  ...
  Line2, //!< Specifies which physical line (or pin) and associated I/O control
         //!< block to use as external source for the trigger signal.
  Line3, //!< Specifies which physical line (or pin) and associated I/O control
         //!< block to use as external source for the trigger signal. AVAILABLE:
         //!< Always
  ...
  LinkTrigger2, //!< Specifies which Link Trigger to use as source for the
                //!< trigger (received from the transport layer).
  LogicBlock0, //!< Specifies which Logic Block signal to use as internal source
               //!< for the trigger.
  LogicBlock1, //!< Specifies which Logic Block signal to use as internal source
               //!< for the trigger.
  LogicBlock2, //!< Specifies which Logic Block signal to use as internal source
               //!< for the trigger.
  Off,      //!< No trigger source is active. AVAILABLE: (ExposureMode = Timed)
  Software, //!< Specifies that the trigger source will be generated by software
            //!< using the TriggerSoftware command.
  SoftwareSignal0, //!< Specifies that the trigger source will be a signal
                   //!< generated by software using the SoftwareSignalPulse
                   //!< command.
  SoftwareSignal1, //!< Specifies that the trigger source will be a signal
                   //!< generated by software using the SoftwareSignalPulse
                   //!< command.
  SoftwareSignal2, //!< Specifies that the trigger source will be a signal
                   //!< generated by software using the SoftwareSignalPulse
                   //!< command.
  Timer0End, //!< Specifies which Timer signal to use as internal source for the
             //!< trigger.
  Timer0Start, //!< Specifies which Timer signal to use as internal source for
               //!< the trigger.
  Timer1End, //!< Specifies which Timer signal to use as internal source for the
             //!< trigger.
  Timer1Start, //!< Specifies which Timer signal to use as internal source for
               //!< the trigger.
  Timer2End, //!< Specifies which Timer signal to use as internal source for the
             //!< trigger.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CTriggerSource(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class UserOutputSelector {
  ...
  UserOutput3, //!< Selects the bit 2 of the User Output register. AVAILABLE:
               //!< Always
  UserOutput4  //!< Selects the bit 3 of the User Output register. AVAILABLE:
               //!< Always
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CUserOutputSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CUserOutputSelector object
  */
  CUserOutputSelector(const CUserOutputSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CUserSetDefault(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CUserSetDefault object
  */
  CUserSetDefault(const CUserSetDefault &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
enum class UserSetFeatureSelector {
  AcquisitionFrameCount = 0, //!< Number of frames to acquire in MultiFrame
                             //!< Acquisition mode. AVAILABLE: Always.
  AcquisitionFrameRate, //!< Controls the acquisition rate (in Hertz) at which
                        //!< the frames are captured. AVAILABLE: Always
  AcquisitionFrameRateEnable, //!< Controls if the AcquisitionFrameRate feature
                              //!< is writable and used to control the
                              //!< acquisition rate. AVAILABLE: Always
  AcquisitionMode, //!< Sets the acquisition mode of the device. It defines
                   //!< mainly the number of frames to capture during an
                   //!< acquisition and the way the acquisition stops.
                   //!< AVAILABLE: Always
  ActionDeviceKey, //!< Provides the device key that allows the device to check
                   //!< the validity of action commands. The device internal
                   //!< assertion of an action signal is only authorized if the
                   //!< ActionDeviceKey and the action device key value in the
                   //!< protocol message are equal. AVAILABLE: Always
  ActionGroupKey, //!< Provides the key that the device will use to validate the
                  //!< action on reception of the action protocol message.
                  //!< AVAILABLE: Always
  ActionGroupMask, //!< Provides the mask that the device will use to validate
                   //!< the action on reception of the action protocol message.
                   //!< AVAILABLE: Always
  AutoFeatureHeight,  //!< Height of the selected Auto Feature Region (in
                      //!< pixels). AVAILABLE: Always.
  AutoFeatureOffsetX, //!< Horizontal offset from the origin to the Auto Feature
                      //!< Region (in pixels). AVAILABLE: Always.
  AutoFeatureOffsetY, //!< Vertical offset from the origin to the Auto Feature
                      //!< Region (in pixels). AVAILABLE: Always.
  AutoFeatureRegionMode, //!< Controls the mode of the selected Auto Feature
                         //!< Region. AVAILABLE: Always.
  AutoFeatureRegionReference, //!< The Reference Region of interest. The Auto
                              //!< Feature Region is part of this region and all
                              //!< Auto Feature Region features are refs to this
                              //!< Reference Region. AVAILABLE: Always.
  AutoFeatureWidth, //!< Width of the selected Auto Feature Region (in pixels).
                    //!< AVAILABLE: Always.
  BOPFShift, //!< Shift Factor for 8bit pixel format caculated from 12 bit mode.
             //!< AVAILABLE: Always.
  BalanceWhiteAuto, //!< Controls the mode for automatic white balancing between
                    //!< the color channels. The white balancing ratios are
                    //!< automatically adjusted. AVAILABLE: Always.
  BinningHorizontal, //!< Number of horizontal photo-sensitive cells to combine
                     //!< together. AVAILABLE: Always
  BinningHorizontalMode, //!< Sets the mode to use to combine horizontal
                         //!< photo-sensitive cells together when
                         //!< BinningHorizontal is used. AVAILABLE: Always
  BinningVertical,     //!< Number of vertical photo-sensitive cells to combine
                       //!< together. AVAILABLE: Always
  BinningVerticalMode, //!< Sets the mode used to combine horizontal
                       //!< photo-sensitive cells together when BinningVertical
                       //!< is used. AVAILABLE: Always
  BlackLevel, //!< Controls the analog black level as an absolute physical
              //!< value. AVAILABLE: Always
  BrightnessAutoNominalValue, //!< Sets the nominal value for brightness in
                              //!< percent of full scale. It will be adjust with
                              //!< consider the setting in
                              //!< BrightnessAutoPriority. AVAILABLE: Always.
  BrightnessAutoPriority, //!< The feature set the highest priority auto feature
                          //!< to adjust the brightness. AVAILABLE: Always.
  ChunkEnable,     //!< Enables the inclusion of the selected Chunk data in the
                   //!< payload of the image. AVAILABLE: Always
  ChunkModeActive, //!< Activates the inclusion of Chunk data in the payload of
                   //!< the image. AVAILABLE: Always
  ColorTransformationAuto,  //!< Controls the mode for automatic adjusting the
                            //!< gains of the active transformation matrix.
                            //!< AVAILABLE: Always.
  ColorTransformationValue, //!< Represents the value of the selected Gain
                            //!< factor or Offset inside the Transformation
                            //!< matrix. AVAILABLE: Always.
  CounterDuration, //!< Sets the duration (or number of events) before the
                   //!< CounterEnd event is generated. AVAILABLE: Always
  CounterEventActivation, //!< Selects the Activation mode Event Source signal.
                          //!< AVAILABLE: Always
  CounterEventSource,     //!< Select the events that will be the source to
  ...
  CounterResetSource, //!< Selects the signals that will be the source to reset
                      //!< the Counter. AVAILABLE: Always
  DefectPixelCorrection, //!< Enable the correction of defect pixels. AVAILABLE:
                         //!< Always
  DeviceLinkThroughputLimit, //!< Limits the maximum bandwidth of the data that
                             //!< will be streamed out by the device on the
                             //!< selected Link. If necessary, delays will be
                             //!< uniformly inserted between transport layer
                             //!< packets in order to control the peak
                             //!< bandwidth. AVAILABLE: Always
  DeviceSpecific,            //!< Device - Specific
  DeviceTemperatureStatusTransition, //!< Temperature threshold for selected
                                     //!< status transition in degrees Celsius
                                     //!< (C). AVAILABLE: Always
  EventNotification, //!< Activate or deactivate the notification to the host
                     //!< application of the occurrence of the selected Event.
                     //!< AVAILABLE: Always
  ExposureAuto,      //!< Sets the automatic exposure mode when ExposureMode is
                //!< Timed. The exact algorithm used to implement this control
                //!< is device-specific. AVAILABLE: Always.
  ExposureAutoMaxValue, //!< Maximal value of ExposureTime calculable by
                        //!< exposure auto algorithm. AVAILABLE: Always.
  ExposureAutoMinValue, //!< Minimal value of ExposureTime calculable by
                        //!< exposure auto algorithm. AVAILABLE: Always.
  ExposureMode, //!< Sets the operation mode of the Exposure (or shutter).
                //!< AVAILABLE: Always
  ExposureTime, //!< Sets the Exposure time when ExposureMode is Timed and
                //!< ExposureAuto is Off. This controls the duration where the
                //!< photosensitive cells are exposed to light. AVAILABLE:
                //!< Always
  FixedPatternNoiseCorrection, //!< Fixed pattern noise correction. AVAILABLE:
                               //!< Always
  FrameCounter, //!< Sets the frame counter, which is part of the chunk data
                //!< too. AVAILABLE: Always
  Gain, //!< Controls the selected gain as an absolute physical value. This is
        //!< an amplification factor applied to the video signal. AVAILABLE:
        //!< Always
  GainAuto, //!< Sets the automatic gain control (AGC) mode. The exact algorithm
            //!< used to implement AGC is device-specific. AVAILABLE: Always.
  GainAutoMaxValue, //!< Maximal value of Gain calculable by gain auto
                    //!< algorithm. AVAILABLE: (GainSelector = All).
  GainAutoMinValue, //!< Minimal value of Gain calculable by gain auto
                    //!< algorithm. AVAILABLE: (GainSelector = All).
  Gamma,    //!< Controls the gamma correction of pixel intensity. This is
            //!< typically used to compensate for non-linearity of the display
            //!< system (such as CRT). AVAILABLE: Always.
  GevSCFTD, //!< This feature indicates the delay (in timestamp counter unit) to
            //!< insert between each block (image) for this stream channel.
            //!< AVAILABLE: Always
  GevSCPD, //!< Controls the delay (in timestamp counter unit) to insert between
  ...
  LUTValue,   //!< Returns the Value at entry LUTIndex of the LUT selected by
              //!< LUTSelector. AVAILABLE: Always.
  LineDebouncerHighTimeAbs, //!< Sets the absolute value of the selected line
                            //!< debouncer time in microseconds for switch from
                            //!< low to high. AVAILABLE: Always
  LineDebouncerLowTimeAbs,  //!< Sets the absolute value of the selected line
                            //!< debouncer time in microseconds for switch from
                            //!< high to low AVAILABLE: Always
  LineInverter, //!< Controls the inversion of the signal of the selected input
                //!< or output Line. AVAILABLE: Always
  LineMode,     //!< Controls if the physical Line is used to Input or Output a
                //!< signal. AVAILABLE: Always.
  ...
  LinePWMMaxDuration, //!< Sets the maximum duration in microseconds. AVAILABLE:
                      //!< Always.
  LinePWMMaxDutyCycle, //!< Offers the maximal duty cycle in percent. AVAILABLE:
                       //!< Always.
  LinePWMMode, //!< Selects the PWM mode of the selected output line. AVAILABLE:
               //!< Always.
  LineSource,  //!< Selects which internal acquisition or I/O source signal to
               //!< output on the selected Line. LineMode must be Output.
               //!< AVAILABLE: Always
  OffsetX, //!< Horizontal offset from the origin to the region of interest (in
           //!< pixels). AVAILABLE: Always
  OffsetY, //!< Vertical offset from the origin to the region of interest (in
           //!< pixels). AVAILABLE: Always
  PixelFormat, //!< Format of the pixels provided by the device. It represents
               //!< all the information provided by PixelCoding, PixelSize,
               //!< PixelColorFilter combined in a single feature. AVAILABLE:
               //!< Always
  PtpEnable,   //!< Enable the Precision Time Protocol (PTP). AVAILABLE: Always.
  PtpMode, //!< Selects the PTP clock type the device will act as. AVAILABLE:
           //!< Always.
  ReadoutMode, //!< Specifies the operation mode of the readout for the
               //!< acquisition. AVAILABLE: Always
  ReverseX, //!< Flip horizontally the image sent by the device. The Region of
            //!< interest is applied after the flipping. AVAILABLE: Always
  ReverseY, //!< Flip vertically the image sent by the device. The Region of
            //!< interest is applied after the flipping. AVAILABLE: Always
  SensorADDigitization, //!< The feature controls the sensors AD digitization in
                        //!< bits per pixels. AVAILABLE: Always.
  SensorShutterMode,    //!< Sets the shutter mode of the device. AVAILABLE:
                        //!< Always.
  SequencerMode, //!< Controls if the sequencer mechanism is active. AVAILABLE:
                 //!< Always
  SequencerSetNext,  //!< Specifies the next sequencer set. AVAILABLE: Always
  SequencerSetStart, //!< Sets the initial/start sequencer set, which is the
                     //!< first set used within a sequencer. AVAILABLE: Always
  SequencerTriggerActivation, //!< Specifies the activation mode of the
                              //!< sequencer trigger. AVAILABLE: Always
  SequencerTriggerSource,  //!< Specifies the internal signal or physical input
                           //!< line to use as the sequencer trigger source.
                           //!< AVAILABLE: Always
  ShortExposureTimeEnable, //!< Controls if short exposure time should be
                           //!< supported. AVAILABLE: Always
  TestPattern, //!< Selects the type of test pattern that is generated by the
               //!< device as image source. AVAILABLE: Always
  TimerDelay,  //!< Sets the duration (in microseconds) of the delay to apply at
               //!< the reception of a trigger before starting the Timer.
               //!< AVAILABLE: Always
  TimerDuration, //!< Sets the duration (in microseconds) of the Timer pulse.
                 //!< AVAILABLE: Always
  TimerTriggerActivation, //!< Selects the activation mode of the trigger to
                          //!< start the Timer. AVAILABLE: Always
  ...
  TransferStart, //!< Starts the streaming of data blocks out of the device.
                 //!< This feature must be available when the
                 //!< TransferControlMode is set to "UserControled". If the
                 //!< TransferStart feature is not writable (locked), the
                 //!< application should not start the transfer and should avoid
                 //!< using the feature until it becomes writable again.
                 //!< AVAILABLE: Always
  TransferStop,  //!< Stops the streaming of data Block(s). The current block
                 //!< transmission will be completed. This feature must be
                 //!< available when the TransferControlMode is set to
                 //!< "UserControlled". AVAILABLE: Always
  TriggerActivation, //!< Specifies the activation mode of the trigger.
                     //!< AVAILABLE: Always
  TriggerDelay, //!< Specifies the delay in microseconds (us) to apply after the
                //!< trigger reception before activating it. AVAILABLE: Always
  TriggerMode,  //!< Controls if the selected trigger is active. AVAILABLE:
                //!< Always
  TriggerSource, //!< Specifies the internal signal or physical input Line to
                 //!< use as the trigger source. The selected trigger must have
                 //!< its TriggerMode set to On. AVAILABLE: Always
  UserOutputValue,    //!< Sets the value of the bit selected by
                      //!< UserOutputSelector. AVAILABLE: Always
  UserOutputValueAll, //!< Sets the value of all the bits of the User Output
                      //!< register. It is subject to the
                      //!< UserOutputValueAllMask. AVAILABLE: Always
  Width //!< Width of the image provided by the device (in pixels). AVAILABLE:
        //!< Always
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CUserSetFeatureSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CUserSetFeatureSelector object
  */
  CUserSetFeatureSelector(const CUserSetFeatureSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CUserSetFeatureSelector &
  operator=(const CUserSetFeatureSelector &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CUserSetSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CUserSetSelector object
  */
  CUserSetSelector(const CUserSetSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
*/
class NEOAPI_CPP_DECL CboCalibrationDataConfigurationMode
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CboCalibrationDataConfigurationMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CboCalibrationDataConfigurationMode(
      const CboCalibrationDataConfigurationMode &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CboCalibrationDataConfigurationMode object to
     assign. \return     Object reference with the value set.
  */
  const CboCalibrationDataConfigurationMode &
  operator=(const CboCalibrationDataConfigurationMode &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The boCalibrationDataConfigurationMode value to be
     written. \return    The CboCalibrationDataConfigurationMode object
  */
  CboCalibrationDataConfigurationMode &
  operator=(boCalibrationDataConfigurationMode value);
  /**
      \brief     Set the current value.
      \param     value The boCalibrationDataConfigurationMode value to be
     written. \return    The CboCalibrationDataConfigurationMode object
  */
  CboCalibrationDataConfigurationMode &
  Set(boCalibrationDataConfigurationMode value);
  /**
      \brief     Get the current value.
      \return    The value as boCalibrationDataConfigurationMode
  */
...
enum class boCalibrationMatrixSelector {
  ...
  NewCameraMatrix   //!< Selects the camera matrix with consideration of the
                    //!< geometry distortion.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboCalibrationMatrixSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboCalibrationMatrixSelector object
  */
  CboCalibrationMatrixSelector(const CboCalibrationMatrixSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboCalibrationMatrixSelector &
  operator=(const CboCalibrationMatrixSelector &object);
  /**
      \brief     Get the current value.
...
*/
class NEOAPI_CPP_DECL CboCalibrationMatrixValueSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CboCalibrationMatrixValueSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CboCalibrationMatrixValueSelector(
      const CboCalibrationMatrixValueSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboCalibrationMatrixValueSelector &
  operator=(const CboCalibrationMatrixValueSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  CboCalibrationMatrixValueSelector &
  operator=(boCalibrationMatrixValueSelector value);
  /**
      \brief     Set the current value.
      \param     value The boCalibrationMatrixValueSelector value to be written.
      \return    The CboCalibrationMatrixValueSelector object
  */
  CboCalibrationMatrixValueSelector &
  Set(boCalibrationMatrixValueSelector value);
  /**
      \brief     Get the current value.
      \return    The value as boCalibrationMatrixValueSelector
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboCalibrationVectorSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboCalibrationVectorSelector object
  */
  CboCalibrationVectorSelector(const CboCalibrationVectorSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboCalibrationVectorSelector &
  operator=(const CboCalibrationVectorSelector &object);
  /**
      \brief     Get the current value.
...
*/
class NEOAPI_CPP_DECL CboCalibrationVectorValueSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CboCalibrationVectorValueSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CboCalibrationVectorValueSelector(
      const CboCalibrationVectorValueSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboCalibrationVectorValueSelector &
  operator=(const CboCalibrationVectorValueSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  CboCalibrationVectorValueSelector &
  operator=(boCalibrationVectorValueSelector value);
  /**
      \brief     Set the current value.
      \param     value The boCalibrationVectorValueSelector value to be written.
      \return    The CboCalibrationVectorValueSelector object
  */
  CboCalibrationVectorValueSelector &
  Set(boCalibrationVectorValueSelector value);
  /**
      \brief     Get the current value.
      \return    The value as boCalibrationVectorValueSelector
  */
...
*/
class NEOAPI_CPP_DECL CboGeometryDistortionValueSelector
    : public EnumerationFeature {
public:
  /**
      \brief      Constructor
      ...
      \param      name Name of the Feature
  */
  CboGeometryDistortionValueSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
  ...
  */
  CboGeometryDistortionValueSelector(
      const CboGeometryDistortionValueSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      \brief      Assignment operator
      \param      object The CboGeometryDistortionValueSelector object to
     assign. \return     Object reference with the value set.
  */
  const CboGeometryDistortionValueSelector &
  operator=(const CboGeometryDistortionValueSelector &object);
  /**
      \brief     Get the current value.
  ...
  */
  ...
  /**
      \brief     Set the current value.
      \param     value The boGeometryDistortionValueSelector value to be
     written. \return    The CboGeometryDistortionValueSelector object
  */
  CboGeometryDistortionValueSelector &
  operator=(boGeometryDistortionValueSelector value);
  /**
      \brief     Set the current value.
      \param     value The boGeometryDistortionValueSelector value to be
     written. \return    The CboGeometryDistortionValueSelector object
  */
  CboGeometryDistortionValueSelector &
  Set(boGeometryDistortionValueSelector value);
  /**
      \brief     Get the current value.
      \return    The value as boGeometryDistortionValueSelector
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboSerialConfigBaudRate(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboSerialConfigBaudRate object
  */
  CboSerialConfigBaudRate(const CboSerialConfigBaudRate &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboSerialConfigBaudRate &
  operator=(const CboSerialConfigBaudRate &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboSerialConfigDataBits(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboSerialConfigDataBits object
  */
  CboSerialConfigDataBits(const CboSerialConfigDataBits &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboSerialConfigDataBits &
  operator=(const CboSerialConfigDataBits &object);
  /**
      \brief     Get the current value.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboSerialConfigParity(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboSerialConfigParity object
  */
  CboSerialConfigParity(const CboSerialConfigParity &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboSerialConfigStopBits(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboSerialConfigStopBits object
  */
  CboSerialConfigStopBits(const CboSerialConfigStopBits &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
  ...
  /**
      ...
      \return     Object reference with the value set.
  */
  const CboSerialConfigStopBits &
  operator=(const CboSerialConfigStopBits &object);
  /**
      \brief     Get the current value.
...
enum class boSerialMode {
  Bypass = 0,   //!< Bypass mode. UART1 of Power and Process Interface and UART0
                //!< Interface are connected.
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboSerialMode(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
...
enum class boSerialSelector {
  UART0 = 0, //!< Selects the UART0 Interface which can be used, for example, to
             //!< control optical components.
  UART1 //!< Selects the UART1 Interface which is part of the Power and Process
        //!< Interface and can be used for RS232 communication.
};
...
public:
  /**
      ...
      \param      name Name of the Feature
  */
  CboSerialSelector(CamBase *cam, const NeoString &name)
      : EnumerationFeature(cam, name) {}
  /**
      \brief      Copy-Constructor
      \param      feature A CboSerialSelector object
  */
  CboSerialSelector(const CboSerialSelector &feature)
      : EnumerationFeature(feature) {}
  /**
      \brief      Destructor
  */
...
public:
  /**
      ...
      \param      cam Pointer to the camera
  */
  explicit FeatureAccess(CamBase *cam);
  /**
      \brief      Copy-Constructor
  ...
  */
  ...
  /**
      \brief      Aborts the Acquisition immediately. This will end the capture
  ...
  */
  ...
  /**
      \brief      Controls the acquisition rate (in Hertz) at which the frames
     are captured.
  */
  DoubleFeature AcquisitionFrameRate;
  /**
      \brief      Controls if the AcquisitionFrameRate feature is writable and
     used to control the acquisition rate. Otherwise, the acquisition rate is
     implicitly controlled by the combination of other features like
     ExposureTime, etc...
  */
  BoolFeature AcquisitionFrameRateEnable;
  /**
      \brief      Returns the maximal acquisition rate (in Hertz) at which the
     frames are captured.
  */
  DoubleFeature AcquisitionFrameRateLimit;
  /**
      \brief      Sets the acquisition mode of the device. It defines mainly the
     number of frames to capture during an acquisition and the way the
     acquisition stops.
  */
  CAcquisitionMode AcquisitionMode;
  /**
      \brief      Starts the Acquisition of the device. The number of frames
     captured is specified by AcquisitionMode.
  */
  CommandFeature AcquisitionStart;
  /**
      \brief      Controls if the Acquisition of the device starts automatically
     at device start or not.
  */
  BoolFeature AcquisitionStartAuto;
  /**
      \brief      Reads the state of the internal acquisition signal selected
     using AcquisitionStatusSelector.
  */
  BoolFeature AcquisitionStatus;
  /**
      \brief      Selects the internal acquisition signal to read using
     AcquisitionStatus.
  */
  CAcquisitionStatusSelector AcquisitionStatusSelector;
  /**
      \brief      Stops the Acquisition of the device at the end of the current
     Frame. It is mainly used when AcquisitionMode is Continuous but can be used
     in any acquisition mode.
  */
  CommandFeature AcquisitionStop;
  /**
      \brief      Provides the device key that allows the device to check the
     ...
     value in the protocol message are equal.
  */
  IntegerFeature ActionDeviceKey;
  /**
      \brief      Provides the key that the device will use to validate the
     action on reception of the action protocol message.
  */
  IntegerFeature ActionGroupKey;
  /**
      \brief      Provides the mask that the device will use to validate the
     action on reception of the action protocol message.
  */
  ...
  */
  ...
  /**
      \brief      Sets the aperture (also called iris, f-number, f-stop or f/#)
     of the lens. The lower the f/# the more light goes through the lens (the
     "faster" the lens) and the smaller the depth of field.
  */
  DoubleFeature Aperture;
  /**
      \brief      Initializes the aperture and makes it ready for use. The
     aperture position after initialization is implementation dependent. This
     feature is only implemented if an additional initialization is required
     after OpticControllerInitialize.
  */
  ...
  */
  ...
  /**
      \brief      ApertureStepper controls the stepper value of the Aperture. 0
     is the maximum opening.
  */
  IntegerFeature ApertureStepper;
  /**
      \brief      Returns the Cycle Time of auto feature control loop in
     milliseconds for once and continuous mode.
  */
  DoubleFeature AutoFeatureCycleTime;
  /**
      \brief      Sets the height of the selected Auto Feature Region (in
     pixels).
  */
  IntegerFeature AutoFeatureHeight;
  /**
      \brief      Sets the horizontal offset from the origin to the Auto Feature
     Region (in pixels).
  */
  IntegerFeature AutoFeatureOffsetX;
  /**
      \brief      Sets the vertical offset from the origin to the Auto Feature
     Region (in pixels).
  */
  ...
  */
  ...
  /**
      \brief      Selects the Reference Region of interest. The Auto Feature
     Region is part of this region and all Auto Feature Region features refers
     to this Reference Region.
  */
  CAutoFeatureRegionReference AutoFeatureRegionReference;
  /**
      \brief      Selects the region of interest to control. The RegionSelector
  ...
  */
  ...
  /**
      \brief      Selects the shift factor for 8bit pixel format calculated from
     12 bit mode.
  */
  CBOPFShift BOPFShift;
  /**
      \brief      Controls the mode for automatic white balancing between the
     color channels. The white balancing ratios are automatically adjusted.
  */
  ...
  */
  CBaudrate Baudrate;
  /**
      \brief      Number of horizontal photo-sensitive cells to combine
     together. This reduces the horizontal resolution (width) of the image.
  */
  IntegerFeature BinningHorizontal;
  /**
      \brief      Sets the mode to use to combine horizontal photo-sensitive
     cells together when BinningHorizontal is used.
  */
  CBinningHorizontalMode BinningHorizontalMode;
  /**
      \brief      Sets the number of horizontal and vertical photo-sensitive
     cells to combine together calculated in camera.
  */
  IntegerFeature BinningRegion0;
  /**
      \brief      Selects which binning engine is controlled by the
     BinningHorizontal and BinningVertical features.
  */
  CBinningSelector BinningSelector;
  /**
      \brief      Sets the number of horizontal and vertical photo-sensitive
     cells to combine together calculated in sensor.
  */
  ...
  */
  ...
  /**
      \brief      Sets the mode to use to combine vertical photo-sensitive cells
     together when BinningVertical is used.
  */
  CBinningVerticalMode BinningVerticalMode;
  /**
      \brief      Enables the feature BitShift of 2 for using LSBs with
     pixelformat Mono8.
  */
  ...
  */
  ...
  /**
      \brief      Controls the analog black level as a raw integer value. This
     represents a DC offset applied to the video signal.
  */
  IntegerFeature BlackLevelRaw;
  /**
      \brief      Selects which Black Level is controlled by the various Black
     Level features.
  */
  ...
  */
  ...
  /**
      \brief      Controls the sensor internal feature for avoiding the black
     sun effect.
  */
  ...
  */
  ...
  /**
      \brief      Sets the sequencer sets number of horizontal photo-sensitive
     cells to combine together. This increases the intensity (or signal to noise
     ratio) of the pixels and reduces the horizontal resolution (width) of the
     image.
  */
  IntegerFeature BoSequencerBinningHorizontal;
  /**
      \brief      Sets the sequencer sets number of vertical photo-sensitive
     cells to combine together. This increases the intensity (or signal to noise
     ratio) of the pixels and reduces the vertical resolution (height) of the
     image.
  */
  IntegerFeature BoSequencerBinningVertical;
  /**
      \brief      Enables the sequencer for special multi-frame mode. Normal
  ...
  */
  ...
  /**
      \brief      Sets the Sequencers height of the image provided by the device
     (in pixels).
  */
  ...
  */
  ...
  /**
      \brief      Sets the number of digitized samples outputted simultaneously
     by the camera A/D conversion stage for the sequencer.
  */
  ...
  */
  ...
  /**
      \brief      Sets the sequencer sets Read Out Time in us for the current
     format settings.
  */
  ...
  */
  ...
  /**
      \brief      Sets the Sequencers width of the image provided by the device
     (in pixels).
  */
  IntegerFeature BoSequencerWidth;
  /**
      \brief      Sets the automatic gain control (AGC) mode. The exact
     algorithm used to implement AGC is device-specific.
  */
  DoubleFeature BrightnessAutoNominalValue;
  /**
      \brief      Sets the highest priority auto feature to adjust the
     brightness.
  */
  CBrightnessAutoPriority BrightnessAutoPriority;
  /**
      \brief      Enables the Brightness Correction. Brightness Correction is
     available for binning only.
  */
  ...
  */
  ...
  /**
      \brief      Controls the low time in Clock Cycles for the Frame Valid
     signal between two frames.
  */
  IntegerFeature CLFVALLowTime;
  /**
      \brief      Controls the low time in Clock Cycles for the Line Valid
     signal between two lines.
  */
  IntegerFeature CLLVALLowTime;
  /**
      \brief      Controls the number of retransmissions allowed when a message
  ...
  */
  ...
  /**
      \brief      Adds a calibration offset to compensate for an individual
     "roll" angle of the camera, introduced by mounting tolerances. The offset
     is added to all type of output data that incorporates an angle, like false
     color representation and angle of polarization data. The offset is without
     effect to raw data and to degree of linear polarization data.
  */
  DoubleFeature CalibrationAngleOfPolarizationOffset;
  /**
      \brief      Activates the calibration of the four polarized light channels
     by applying matrix calculations and an angle offset.
  */
  BoolFeature CalibrationEnable;
  /**
      \brief      Represents the value of the selected gain factor inside the
     calibration matrix.
  */
  ...
  */
  ...
  /**
      \brief      Returns the request ID of the action command that triggered
     the image.
  */
  IntegerFeature ChunkActionRequestID;
  /**
      \brief      Returns the IP Adress of the action command source that
     triggered the image.
  */
  IntegerFeature ChunkActionSourceIP;
  /**
      \brief      Returns the number of horizontal and vertical photo-sensitive
     cells to combine together calculated in camera.
  */
  ...
  */
  ...
  /**
      \brief      Enables the inclusion of the selected Chunk data in the
     payload of the image.
  */
  BoolFeature ChunkEnable;
  /**
      \brief      Activates the inclusion of Chunk data in the transmitted
     payload.
  */
  ...
  */
  ...
  /**
      \brief      Returns the number of received trigger at the time of the
     FrameStart event.
  */
  IntegerFeature ChunkTriggerCounter;
  /**
      \brief      This Camera Link specific feature describes the configuration
  ...
  */
  ...
  /**
      \brief      This Camera Link specific feature describes the time
     multiplexing of the camera link connection to transfer more than the
     configuration allows, in one single clock.
  */
  CClTimeSlotsCount ClTimeSlotsCount;
  /**
      \brief      Controls the mode for automatic adjusting the gains of the
  ...
  */
  ...
  /**
      \brief      Selects the color transformation factory list tuned to the
     given color temeperature.
  */
  CColorTransformationFactoryListSelector
      ColorTransformationFactoryListSelector;
  /**
      \brief      sRGB Gamma 1: Camera was calibrated for the color space sRGB
     Gamma 1.
  */
  StringFeature ColorTransformationOutputColorSpace;
  /**
      \brief      Resets the ColorTransformation to the selected
     ColorTransformationFactoryList.
  */
  CommandFeature ColorTransformationResetToFactoryList;
  /**
      \brief      Selects which Color Transformation module is controlled by the
     various Color Transformation features.
  */
  CColorTransformationSelector ColorTransformationSelector;
  /**
      \brief      Represents the value of the selected Gain factor or Offset
     inside the Transformation matrix.
  */
  DoubleFeature ColorTransformationValue;
  /**
      \brief      Selects the Gain factor or Offset of the Transformation matrix
  ...
  */
  ...
  /**
      \brief      Sets the duration (or number of events) before the CounterEnd
     event is generated.
  */
  ...
  */
  ...
  /**
      \brief      Select the events that will be the source to increment the
     Counter.
  */
  ...
  */
  ...
  /**
      \brief      Selects the Activation mode of the Counter Reset Source
     signal.
  */
  CCounterResetActivation CounterResetActivation;
  /**
      \brief      Selects the signals that will be the source to reset the
     Counter.
  */
  ...
  */
  ...
  /**
      \brief      Reads the value of the selected Counter when it was reset by a
     trigger or by an explicit CounterReset command.
  */
  ...
  */
  ...
  /**
      \brief      Horizontal sub-sampling of the image. This reduces the
     horizontal resolution (width) of the image by the specified horizontal
     decimation factor.
  */
  IntegerFeature DecimationHorizontal;
  /**
      \brief      Sets the mode used to reduce the horizontal resolution when
     DecimationHorizontal is used.
  */
  CDecimationHorizontalMode DecimationHorizontalMode;
  /**
      \brief      Vertical sub-sampling of the image. This reduces the vertical
     resolution (height) of the image by the specified vertical decimation
     factor.
  */
  IntegerFeature DecimationVertical;
  /**
      \brief      Sets the mode used to reduce the Vertical resolution when
     DecimationVertical is used.
  */
  ...
  */
  ...
  /**
      \brief      Determines if the pixel correction is active for the selected
     entry.
  */
  ...
  */
  ...
  /**
      \brief      Indicates the number of event channels supported by the
     device.
  */
  ...
  */
  ...
  /**
      \brief      Returns if the license at the device is valid or not for the
     license type, selected by the DeviceLicenseTypeSelector feature.
  */
  ...
  */
  ...
  /**
      \brief      Indicates the command timeout of the specified Link. This
  ...
  */
  ...
  /**
      \brief      Indicates the speed of transmission negotiated on the
     specified Link.
  */
  IntegerFeature DeviceLinkSpeed;
  /**
      \brief      Limits the maximum bandwidth of the data that will be streamed
     out by the device on the selected Link. If necessary, delays will be
     uniformly inserted between transport layer packets in order to control the
     peak bandwidth.
  */
  ...
  */
  ...
  /**
      \brief      Resets the device to its power up state. After reset, the
     device must be rediscovered.
  */
  ...
  */
  ...
  /**
      \brief      Major version of the Standard Features Naming Convention that
     was used to create the device's GenICam XML.
  */
  IntegerFeature DeviceSFNCVersionMajor;
  /**
      \brief      Minor version of the Standard Features Naming Convention that
     was used to create the device's GenICam XML.
  */
  IntegerFeature DeviceSFNCVersionMinor;
  /**
      \brief      Sub minor version of Standard Features Naming Convention that
     was used to create the device's GenICam XML.
  */
  ...
  */
  ...
  /**
      \brief      Selects which sensor is controlled by the various sensor
     specific features.
  */
  ...
  */
  ...
  /**
      \brief      Device's serial number. This string is a unique identifier of
     the device.
  */
  StringFeature DeviceSerialNumber;
  /**
      \brief      This feature controls the baud rate used by the selected
     serial port.
  */
  ...
  */
  ...
  /**
      \brief      Indicates the number of streaming channels supported by the
     device.
  */
  ...
  */
  ...
  /**
      \brief      Specifies the stream packet size, in bytes, to send on the
  ...
  */
  ...
  /**
      \brief      This device tap geometry feature describes the geometrical
     properties characterizing the taps of a camera as presented at the output
     of the device.
  */
  CDeviceTapGeometry DeviceTapGeometry;
  /**
      \brief      Device temperature in degrees Celsius (C). It is measured at
     the location selected by DeviceTemperatureSelector.
  */
  DoubleFeature DeviceTemperature;
  /**
      \brief      Returns if the device operates in a critical temperature
     range.
  */
  ...
  */
  ...
  /**
      \brief      Selects the location within the device, where the temperature
     will be measured.
  */
  ...
  */
  ...
  /**
      \brief      Sets the temperature threshold for the selected status
     transition in degrees Celsius.
  */
  IntegerFeature DeviceTemperatureStatusTransition;
  /**
      \brief      Selects which temperature transition is controlled by the
     feature DeviceTemperatureStatusTransition.
  */
  CDeviceTemperatureStatusTransitionSelector
  ...
  */
  ...
  /**
      \brief      Returns the USB3 Vision unique ID which allows consistent
  ...
  */
  ...
  /**
      \brief      Controls whether the Energy Efficient / Green Ethernet mode
     (802.3az) in the PHY is activated or not. A device reboot is needed for
     changes to take effect.
  */
  BoolFeature EnergyEfficientEthernetEnable;
  /**
      \brief      Activate or deactivate the notification to the host
     application of the occurrence of the selected Event.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor 1 Concatenation Available
     Event.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor 1 Concatenation Empty
     Event.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor 1 Exposure End Event. It
     can be used to determine precisely when the event occured.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor 2 Concatenation Available
     Event.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor 2 Concatenation Empty
     Event.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor 2 Exposure End Event. It
     can be used to determine precisely when the event occured.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Timestamp of the Sensor Initialization Failed
     Event. It can be used to determine precisely when the event occurred.
  */
  IntegerFeature EventSensorInitializationFailedTimestamp;
  /**
      \brief      Returns the unique Identifier of the bo Serial UART0 Read
     Ready type of Event.
  */
  ...
  */
  ...
  /**
      \brief      Returns the unique Identifier of the bo Serial UART1 Read
     Ready type of Event.
  */
  ...
  */
  ...
  /**
     ...
     The exact algorithm used to implement this control is device-specific.
  */
  CExposureAuto ExposureAuto;
  /**
      \brief      Sets the maximal value of ExposureTime calculable by exposure
     auto algorithm.
  */
  DoubleFeature ExposureAutoMaxValue;
  /**
      \brief      Sets the minimal value of ExposureTime calculable by exposure
     auto algorithm.
  */
  DoubleFeature ExposureAutoMinValue;
  /**
      \brief      Sets the offset correction value that the camera applies to
     each even line in the "Exposure Lines" region when it is located on an even
     line.
  */
  IntegerFeature ExposureLinesOffsetEven;
  /**
      \brief      Sets the offset correction value that the camera applies to
     each odd line in the "Exposure Lines" region when it is located on an even
     line.
  */
  ...
  */
  ...
  /**
      \brief      Sets the Exposure time when ExposureMode is Timed and
     ExposureAuto is Off. This controls the duration where the photosensitive
  ...
  */
  ...
  /**
      \brief      Initializes the focal length and makes it ready for use. The
     focal length position after initialization is implementation dependent.
     This feature is only implemented if an additional initialization is
     required after OpticControllerInitialize.
  */
  ...
  */
  ...
  /**
      \brief      Focal power (in diopters/dpt) is mostly used for liquid lenses
     and indicates how much a liquid lens focuses.
  */
  DoubleFeature FocalPower;
  /**
      \brief      Initializes the focus and makes it ready for use. The focus
     position after initialization is implementation dependent. This feature is
     only implemented if an additional initialization is required after
  ...
  */
  ...
  /**
      \brief      FocusStepper controls the stepper value of the Focus, e.g.
     ObjectSensorDistance or FocalPower. 0 is the closest focus.
  */
  IntegerFeature FocusStepper;
  /**
      \brief      Sets the frame counter. The frame counter will be incremented
     with every image taken by the camera. It can be manipulated by writing the
     features value.
  */
  ...
  */
  ...
  /**
      \brief      Controls the selected gain as an absolute physical value. This
     is an amplification factor applied to the video signal.
  */
  DoubleFeature Gain;
  /**
      \brief      Sets the automatic gain control (AGC) mode. The exact
  ...
  */
  CGainAuto GainAuto;
  /**
      \brief      Sets the maximal value of Gain calculable by gain auto
     algorithm.
  */
  DoubleFeature GainAutoMaxValue;
  /**
      \brief      Sets the minimal value of Gain calculable by gain auto
     algorithm.
  */
  ...
  */
  ...
  /**
      \brief      Controls the gamma correction of pixel intensity. This is
     typically used to compensate for non-linearity of the display system (such
     as CRT).
  */
  DoubleFeature Gamma;
  /**
  ...
  */
  CGevCCP GevCCP;
  /**
      \brief      Reports the default gateway IP address of the given logical
     link.
  */
  ...
  */
  ...
  /**
      \brief      Controls whether the DHCP IP configuration scheme is activated
     on the given logical link.
  */
  BoolFeature GevCurrentIPConfigurationDHCP;
  /**
      \brief      Controls whether the Link Local Address IP configuration
     scheme is activated on the given logical link.
  */
  BoolFeature GevCurrentIPConfigurationLLA;
  /**
      \brief      Controls whether the PersistentIP configuration scheme is
  ...
  */
  ...
  /**
      \brief      Indicates the maximum randomized delay the device will wait to
     acknowledge a discovery command.
  */
  IntegerFeature GevDiscoveryAckDelay;
  /**
      \brief      Indicates the first URL to the GenICam XML device description
     file. The First URL is used as the first choice by the application to
     retrieve the GenICam XML device description file.
  */
  ...
  */
  ...
  /**
      \brief      Selects the GigE Vision version to control extended status
     codes for.
  */
  ...
  */
  ...
  /**
      \brief      This feature indicates the source port for the message
     channel.
  */
  ...
  */
  ...
  /**
      \brief      Controls whether incoming PAUSE Frames are handled on the
     given logical link.
  */
  BoolFeature GevPAUSEFrameReception;
  /**
      \brief      Controls whether PAUSE Frames can be generated on the given
     logical link.
  */
  BoolFeature GevPAUSEFrameTransmission;
  /**
      \brief      Controls the persistent default gateway for this logical link.
     It is only used when the device boots with the Persistent IP configuration
     scheme.
  */
  IntegerFeature GevPersistentDefaultGateway;
  /**
      \brief      Controls the Persistent IP address for this logical link. It
     is only used when the device boots with the Persistent IP configuration
     scheme.
  */
  IntegerFeature GevPersistentIPAddress;
  /**
      \brief      Controls the Persistent subnet mask associated with the
     Persistent IP address on this logical link. It is only used when the device
     boots with the Persistent IP configuration scheme.
  */
  ...
  */
  ...
  /**
      \brief      Controls the key to use to authenticate primary application
     switchover requests.
  */
  IntegerFeature GevPrimaryApplicationSwitchoverKey;
  /**
      \brief      Enables the camera to continue to stream, for this stream
  ...
  */
  ...
  /**
      \brief      Controls the destination IP address of the selected stream
  ...
  */
  ...
  /**
      \brief      Indicates the delay in timestamp counter unit to insert
     between each block (image) for the selected Stream Channel.
  */
  IntegerFeature GevSCFTD;
  /**
      \brief      Controls the delay (in GEV timestamp counter unit) to insert
     ...
     cannot keep up with the packets coming from the device.
  */
  IntegerFeature GevSCPD;
  /**
      \brief      Controls the port of the selected channel to which a GVSP
     transmitter must send data stream or the port from which a GVSP receiver
     may receive data stream. Setting this value to 0 closes the stream channel.
  */
  ...
  */
  ...
  /**
      \brief      The state of this feature is copied into the "do not fragment"
     bit of IP header of each stream packet. It can be used by the application
     to prevent IP fragmentation of packets on the stream channel.
  */
  BoolFeature GevSCPSDoNotFragment;
  /**
      \brief      Sends a test packet. When this feature is set, the device will
     fire one test packet.
  */
  BoolFeature GevSCPSFireTestPacket;
  /**
      \brief      This GigE Vision specific feature corresponds to
     DeviceStreamChannelPacketSize and should be kept in sync with it. It
     specifies the stream packet size, in bytes, to send on the selected channel
     for a GVSP transmitter or specifies the maximum packet size supported by a
     GVSP receiver.
  */
  ...
  */
  ...
  /**
      \brief      Indicates the second URL to the GenICam XML device description
     file. This URL is an alternative if the application was unsuccessful to
  ...
  */
  ...
  /**
      \brief      Sets the ratio of the total exposure time for the selected
     slope.
  */
  IntegerFeature HDRExposureRatio;
  /**
      \brief      Returns the ratio of the total exposure time for the selected
     slope expressed in percent.
  */
  DoubleFeature HDRExposureRatioPercent;
  /**
      \brief      Returns the exposure time for bright areas of image. This
     value represents the short exposure time, which is derived from (long)
     ExposureTime divided by HDRExposureTimeRatio.
  */
  DoubleFeature HDRExposureTimeBrightArea;
  /**
      \brief      Returns the exposure time for dark areas of image. This value
     represents the long exposure timea and is equal to the specified value of
     the standard feature ExposureTime.
  */
  DoubleFeature HDRExposureTimeDarkArea;
  /**
      \brief      Sets the exposure time ratio for HDR mode. Valid values are
     only power-of-two numbers. The feature will snap to next/previous valid
     value when current value is incremented/decremented, else it will round to
     nearest valid value.
  */
  IntegerFeature HDRExposureTimeRatio;
  /**
      \brief      Returns the sensor gain for bright areas of image. This value
     represents the lower gain used as offset for the HDR image.
  */
  IntegerFeature HDRGainBrightArea;
  /**
      \brief      Returns the sensor gain for dark areas of image. This value
     represents the higher gain, which is derived from lower gain and
     HDRGainRatio.
  */
  ...
  */
  ...
  /**
      \brief      Enables the calculation of an interleaved HDR image of the
     sensor to an HDR image. If this feature is disabled while HDR is enabled
     the interleaved HDR image of the sensor will be output.
  */
  ...
  */
  ...
  /**
      \brief      Specifies the upper threshold to determine valid pixels for
     HDR processing.
  */
  IntegerFeature HDRProcessingThresholdMax;
  /**
      \brief      Specifies the lower threshold to determine valid pixels for
     HDR processing.
  */
  ...
  */
  ...
  /**
      \brief      Sets the gradient at selected grid point for HDR tone-mapping
     transfer curve.
  */
  ...
  */
  ...
  /**
      \brief      Sets the index of grid point for the user-defined tone-mapping
     curve.
  */
  IntegerFeature HDRTonemappingCurveGridpointIndex;
  /**
      \brief      Sets the offset at selected grid point for HDR tone-mapping
     transfer curve.
  */
  IntegerFeature HDRTonemappingCurveOffset;
  /**
      \brief      Selects the predefined transfer curve for global tone-mapping
     of the calculated HDR image.
  */
  CHDRTonemappingCurvePresetSelector HDRTonemappingCurvePresetSelector;
  /**
      \brief      Resets the tone-mapping curve to the selected
     HDRTonemappingCurvePreset.
  */
  CommandFeature HDRTonemappingCurveResetToPreset;
  /**
      \brief      Enables the tone-mapping of calculated HDR image. If this
     feature is deactivated HDR pixels are only cropped to width of specified
     output pixelformat and HDR information will be lost..
  */
  BoolFeature HDRTonemappingEnable;
  /**
      \brief      Specifies the statistical maximal pixel value for local
     tone-mapping of the calculated HDR image.
  */
  IntegerFeature HDRTonemappingMax;
  /**
      \brief      Specifies the statistical mean value for local tone-mapping of
     the calculated HDR image.
  */
  ...
  */
  ...
  /**
      \brief      Maximum height of the image (in pixels). This dimension is
     calculated after vertical binning, decimation or any other function
  ...
  */
  ...
  /**
      \brief      When JPEG is selected as the compression format, a device
  ...
  */
  ...
  /**
      \brief      Enable a specific image compression mode as the base mode for
     image transfer. Optionally, chunk data can be appended to the compressed
     image.
  */
  ...
  */
  ...
  /**
      \brief      Two rate controlling options are offered: fixed bit rate or
  ...
  */
  ...
  /**
      \brief      Returns the data of the image. The size of the image itself is
     given in the Length element of the feature. The start address is stored in
     the element Address of the feature.
  */
  RegisterFeature ImageData;
  /**
      \brief      Enables the feature ImageData. If it is switch off the feature
     ImageData is not available.
  */
  ...
  */
  ...
  /**
      \brief      Control the index (offset) of the coefficient to access in the
     selected LUT.
  */
  ...
  */
  ...
  /**
      \brief      Returns the Value at entry LUTIndex of the LUT selected by
     LUTSelector.
  */
  IntegerFeature LUTValue;
  /**
      \brief      Sets the absolute value of the selected line debouncer time in
     microseconds for switch from low to high.
  */
  ...
  */
  ...
  /**
      \brief      Sets the absolute value of the selected line debouncer time in
     microseconds for switch from high to low.
  */
  ...
  */
  ...
  /**
      \brief      Controls the current electrical format of the selected
     physical input or output Line.
  */
  CLineFormat LineFormat;
  /**
      \brief      Controls the inversion of the signal of the selected input or
     output Line.
  */
  BoolFeature LineInverter;
  /**
      \brief      Returns the minimal length of a line internal reading by the
     camera in pixels.
  */
  IntegerFeature LineLengthMin;
  /**
      \brief      Controls if the physical Line is used to Input or Output a
     signal.
  */
  CLineMode LineMode;
  /**
  ...
  */
  ...
  /**
      \brief      Returns the off time included in the PWM Period in
     microseconds.
  */
  IntegerFeature LinePWMOffTime;
  /**
      \brief      Returns the period time calculated of the given Duration and
     Duty Cycle in microseconds.
  */
  IntegerFeature LinePWMPeriodTime;
  /**
      \brief      Selects the physical line (or pin) of the external device
     connector or the virtual line of the Transport Layer to configure.
  */
  CLineSelector LineSelector;
  /**
      \brief      Selects which internal acquisition or I/O source signal to
     output on the selected Line. LineMode must be Output.
  */
  CLineSource LineSource;
  /**
      \brief      Returns the current status of the selected input or output
     Line.
  */
  BoolFeature LineStatus;
  /**
      \brief      Returns the current status of all available Line signals at
  ...
  */
  ...
  /**
      \brief      Returns the maximum number of available memory blocks.It
     depends on partial scan features, pixelformat and selected acquisition
     format.
  */
  ...
  */
  ...
  /**
      \brief      Sest the number of available memory blocks in the selected
     memory part.
  */
  IntegerFeature MemoryPartBlocks;
  /**
      \brief      Returns the number of filled memory blocks in the selected
     memory part.
  */
  IntegerFeature MemoryPartFilledBlocks;
  /**
      \brief      Returns the number of free memory blocks in the selected
     memory part.
  */
  IntegerFeature MemoryPartFreeBlocks;
  /**
      \brief      Writes to the command switch the active memory part
     incremental.
  */
  ...
  */
  ...
  /**
      \brief      Sets the ratio of preview images transmitted to host. A Value
     of 0 means no images are transmitted. A Value of 1 means every image will
  ...
  */
  ...
  /**
      \brief      Horizontal offset from the origin to the region of interest
     (in pixels).
  */
  IntegerFeature OffsetX;
  /**
      \brief      Vertical offset from the origin to the region of interest (in
     pixels).
  */
  ...
  */
  ...
  /**
      \brief      Initializes the selected optic controller and makes it ready
     for use.
  */
  ...
  */
  ...
  /**
      \brief      Provides the number of bytes transferred for each data buffer
     or chunk on the stream channel. This includes any end-of-line, end-of-frame
     statistics or other stamp data. This is the total size of data payload for
     a data block.
  */
  ...
  */
  ...
  /**
      \brief      Format of the pixels provided by the device. It represents all
     the information provided by PixelSize, PixelColorFilter combined in a
     single feature.
  */
  CPixelFormat PixelFormat;
  /**
      \brief      Indicates the expected accuracy of the device PTP clock when
     it is the grandmaster, or in the event it becomes the grandmaster.
  */
  ...
  */
  ...
  /**
      \brief      Sets the offset which will be added or subtracted to the
     cameras internal timestamp.
  */
  IntegerFeature PtpClockOffset;
  /**
      \brief      Sets the mode to handle PtpClockOffset for command
     PtpClockOffsetSet.
  */
  CPtpClockOffsetMode PtpClockOffsetMode;
  /**
      \brief      Sets PtpClockOffset active like described in
     PtpClockOffsetMode.
  */
  CommandFeature PtpClockOffsetSet;
  /**
      \brief      Latches the current values from the device's PTP clock data
     set.
  */
  CommandFeature PtpDataSetLatch;
  /**
      \brief      Sets the offset which will be added or subtracted to the
     cameras internal timestamp increment.
  */
  IntegerFeature PtpDriftOffset;
  /**
      \brief      Sets the mode to handle PtpDriftOffset for command
     PtpDriftOffsetSet.
  */
  CPtpDriftOffsetMode PtpDriftOffsetMode;
  /**
      \brief      Sets PtpDriftOffset active like described in
     PtpDriftOffsetMode.
  */
  ...
  */
  ...
  /**
      \brief      Returns the latched grandmaster clock ID of the PTP device.
     The grandmaster clock ID is the clock ID of the current grandmaster clock.
  */
  IntegerFeature PtpGrandmasterClockID;
  /**
      \brief      Sets ki value of servos pi controller if
     PtpUseControllerTestSettings = True.
  */
  DoubleFeature PtpKi;
  /**
      \brief      Sets kp value of servos pi controller if
     PtpUseControllerTestSettings = True.
  */
  DoubleFeature PtpKp;
  /**
  ...
  */
  CPtpMode PtpMode;
  /**
      \brief      Returns the latched offset from the PTP master clock in
     nanoseconds.
  */
  IntegerFeature PtpOffsetFromMaster;
  /**
      \brief      Returns the latched parent clock ID of the PTP device. The
     parent clock ID is the clock ID of the current master clock.
  */
  IntegerFeature PtpParentClockID;
  /**
      \brief      Returns the latched state of the clock servo. When the servo
     is in a locked state, the value returned is 'Locked'. When the servo is in
     a non-locked state, a device-specific value can be returned to give
     specific information. If no device-specific value is available to describe
     the current state of the clock servo, the value should be 'Unknown'.
  */
  CPtpServoStatus PtpServoStatus;
  /**
      \brief      Sets the threshold of time difference to Ptp Master Clock for
     transition PtpServoStatus Unknown to Locked.
  */
  ...
  */
  ...
  /**
      \brief      Returns the latched sync message interval from the PTP master
     clock in milliseconds.
  */
  DoubleFeature PtpSyncMessageInterval;
  /**
      \brief      Returns if the latched sync message interval from the PTP
     master clock is supported by the device. An unsupported sync message
     interval may result in PtpServoStatus instability.
  */
  CPtpSyncMessageIntervalStatus PtpSyncMessageIntervalStatus;
  /**
      \brief      Sets the offset which will be added or subtracted to the ptp
     ethernet Rx and/or Tx timestamps.
  */
  IntegerFeature PtpTimestampOffset;
  /**
      \brief      Sets the mode to handle PtpTimestampOffset for command
     PtpTimestampOffsetSet.
  */
  CPtpTimestampOffsetMode PtpTimestampOffsetMode;
  /**
      \brief      Sets PtpTimestampOffset active like described in
     PtpTimestampOffsetMode.
  */
  ...
  */
  ...
  /**
      \brief      Selects the number of image buffers filled with data of sensor
     output. If all buffers full the oldest buffer will be overwritten.
  */
  ...
  */
  ...
  /**
      \brief      Specifies the operation mode of the readout for the
     acquisition.
  */
  ...
  */
  ...
  /**
      \brief      Controls if the selected Region of interest is active and
     streaming.
  */
  ...
  */
  ...
  /**
      \brief      Flip horizontally the image sent by the device. The Region of
     interest is applied after the flipping.
  */
  BoolFeature ReverseX;
  /**
      \brief      Flip vertically the image sent by the device. The Region of
     interest is applied after the flipping.
  */
  BoolFeature ReverseY;
  /**
      \brief      Controls the length of a serial acknowledge message from RS232
     to the device.
  */
  IntegerFeature RxAcknowledgeLength;
  /**
      \brief      Returns the number of discarded messages in receiving
     direction.
  */
  ...
  */
  ...
  /**
      \brief      Returns the length of the current received message in the
     RS232-Rx FIFO and 0 if no message was received.
  */
  IntegerFeature RxFiFoMessageLength;
  /**
      \brief      Sets the number of attempts to receive a message if direct
     receiving was not successful.
  */
  IntegerFeature RxRetryCount;
  /**
      \brief      Sets the maximum delay between to received bytes for
     recognition of message ends in bit times.
  */
  IntegerFeature RxSynchronizationDelay;
  /**
      \brief      Sets the maximum delay between to received bytes for
     recognition of message ends in us.
  */
  ...
  */
  ...
  /**
      \brief      The start point of pixel 0 on a line for sensor 1. It is
     programmed during sensor adjustment.
  */
  ...
  */
  ...
  /**
      \brief      The start point of line 0 for in the image for sensor 1. It is
     programmed during sensor adjustment.
  */
  ...
  */
  ...
  /**
      \brief      The start point of pixel 0 on a line for sensor 2. It is
     programmed during sensor adjustment.
  */
  ...
  */
  ...
  /**
      \brief      The start point of line 0 for in the image for sensor 2. It is
     programmed during sensor adjustment.
  */
  ...
  */
  ...
  /**
      \brief      Number of digitized samples outputted simultaneously by the
  ...
  */
  ...
  /**
      \brief      Returns the number of lost frames because of sensor FIFO
     overflow.
  */
  ...
  */
  ...
  /**
      \brief      Physical size (pitch) in the y direction of a photo sensitive
     pixel unit.
  */
  DoubleFeature SensorPixelHeight;
  /**
      \brief      Physical size (pitch) in the x direction of a photo sensitive
     pixel unit.
  */
  ...
  */
  ...
  /**
      \brief      Enables the selected feature and make it active in all the
     sequencer sets.
  */
  ...
  */
  ...
  /**
      \brief      Loads the sequencer set selected by SequencerSetSelector in
     the device. Even if SequencerMode is off, this will change the device state
     to the configuration of the selected set.
  */
  ...
  */
  ...
  /**
      \brief      Saves the current device state to the sequencer set selected
     by the SequencerSetSelector.
  */
  CommandFeature SequencerSetSave;
  /**
      \brief      Selects the sequencer set to which further feature settings
     applies.
  */
  IntegerFeature SequencerSetSelector;
  /**
      \brief      Sets the initial/start sequencer set, which is the first set
     used within a sequencer.
  */
  ...
  */
  ...
  /**
      \brief      Specifies the internal signal or physical input line to use as
     the sequencer trigger source.
  */
  ...
  */
  ...
  /**
      \brief      Controls if short exposure time should be supported. Note if
     this feature is enabled one cannot use the sequencer.
  */
  BoolFeature ShortExposureTimeEnable;
  /**
      \brief      Enables the correction of Shutter Line and Exposure Lines when
     set to True, disables it when set to False.
  */
  BoolFeature ShutterLineCorrectionEnable;
  /**
      \brief      Sets the offset correction value that the camera applies to
     the even line in the "Shutter Line" region.
  */
  IntegerFeature ShutterLineOffsetEven;
  /**
      \brief      Sets the offset correction value that the camera applies to
     the odd line in the "Shutter Line" region.
  */
  IntegerFeature ShutterLineOffsetOdd;
  /**
      \brief      Controls or returns the number of sources supported by the
     device.
  */
  IntegerFeature SourceCount;
  /**
      \brief      Returns a unique Identifier value that correspond to the
     selected Source.
  */
  CSourceID SourceID;
  /**
  ...
  */
  ...
  /**
      \brief      Returns if the selected MAC address table entry is valid or
     not.
  */
  BoolFeature SwitchMACAddressTableEntryIsValid;
  /**
      \brief      Provides the MAC address of the selected MAC address table
     entry.
  */
  IntegerFeature SwitchMACAddressTableEntryMACAddress;
  /**
      \brief      Provides the port number of the selected MAC address table
     entry.
  */
  IntegerFeature SwitchMACAddressTableEntryPortNumber;
  /**
      \brief      Selects the MAC addresses table entry for the MAC address
     table entry related features.
  */
  IntegerFeature SwitchMACAddressTableEntrySelector;
  /**
      \brief      Provides the number MAC addresses at switches MAC address
     table.
  */
  ...
  */
  ...
  /**
      \brief      Used by the Transport Layer to prevent critical features from
     changing during acquisition.
  */
  IntegerFeature TLParamsLocked;
  /**
      \brief      Selects the type of test pattern that is generated by the
     device as image source.
  */
  CTestPattern TestPattern;
  /**
      \brief      Selects which test pattern generator is controlled by the
     TestPattern feature.
  */
  CTestPatternGeneratorSelector TestPatternGeneratorSelector;
  /**
      \brief      Tests the device's pending acknowledge feature. When this
     feature is written, the device waits a time period corresponding to the
     value of TestPendingAck before acknowledging the write.
  */
  IntegerFeature TestPendingAck;
  /**
      \brief      Sets the duration (in microseconds) of the delay to apply at
     the reception of a trigger before starting the Timer.
  */
  ...
  */
  ...
  /**
      \brief      Latches the current timestamp counter into
     TimestampLatchValue.
  */
  ...
  */
  ...
  /**
      \brief      Returns the latched value of the Ptp timestamp in days since
     01.01.1970 00:00:00.
  */
  IntegerFeature TimestampLatchValuePtpDays;
  /**
      \brief      Returns the latched value of the Ptp timestamp in hours since
     00:00 AM.
  */
  IntegerFeature TimestampLatchValuePtpHours;
  /**
      \brief      Returns the latched value of the Ptp timestamp in minutes
     since the last hour.
  */
  IntegerFeature TimestampLatchValuePtpMinutes;
  /**
      \brief      Returns the latched value of the Ptp timestamp in nanoseconds
     since the last second.
  */
  IntegerFeature TimestampLatchValuePtpNanoseconds;
  /**
      \brief      Returns the latched value of the Ptp timestamp counters in
     seconds since the last minute.
  */
  ...
  */
  ...
  /**
      \brief      Selects which stream transfers are currently controlled by the
     selected Transfer features.
  */
  CTransferSelector TransferSelector;
  /**
      \brief      Starts the streaming of data blocks out of the device. This
     feature must be available when the TransferControlMode is set to
     "UserControlled". If the TransferStart feature is not writable (locked),
     the application should not start the transfer and should avoid using the
     feature until it becomes writable again.
  */
  CommandFeature TransferStart;
  /**
      \brief      Reads the status of the Transfer module signal selected by
  ...
  */
  ...
  /**
      \brief      Stops the streaming of data Block(s). The current block
     transmission will be completed. This feature must be available when the
     TransferControlMode is set to "UserControlled".
  */
  ...
  */
  ...
  /**
      \brief      Specifies the delay in microseconds (us) to apply after the
     trigger reception before activating it.
  */
  DoubleFeature TriggerDelay;
  /**
      \brief      Generates the test event if the event channel for this event
     is enabled.
  */
  ...
  */
  ...
  /**
      \brief      Specifies the type trigger overlap permitted with the previous
     frame or line. This defines when a valid trigger will be accepted (or
     latched) for a new frame or a new line.
  */
  ...
  */
  ...
  /**
      \brief      Generates an internal trigger. TriggerSource must be set to
     Software.
  */
  CommandFeature TriggerSoftware;
  /**
      \brief      Specifies the internal signal or physical input Line to use as
     the trigger source. The selected trigger must have its TriggerMode set to
     On.
  */
  CTriggerSource TriggerSource;
  /**
      \brief      Sets the delay between two consecutive bytes inside a sent
     message in bit times.
  */
  ...
  */
  ...
  /**
      \brief      Sets the Length of a serial command message from device to
     RS232.
  */
  IntegerFeature TxCommandoLength;
  /**
      \brief      Returns the number of unsent or discarded messages in sending
     direction.
  */
  ...
  */
  ...
  /**
      \brief      Returns the number of RS232-Tx FIFO buffers currently free and
     usable.
  */
  IntegerFeature TxFiFoFreeBufferCount;
  /**
      \brief      Sets the minimal delay between last and first byte of two
     consecutive sent messages in bit times.
  */
  IntegerFeature TxMessageDelay;
  /**
      \brief      Returns the minimal delay between last and first byte of two
     consecutive sent messages in us.
  */
  DoubleFeature TxMessageDelayNormalized;
  /**
      \brief      Sets the number of attempts to resend a message if direct
     sending was not successful.
  */
  IntegerFeature TxRetryCount;
  /**
      \brief      Enables the streaming support for USB 2.0. Note, changing
     features value causes in an automatically reset of the device!
  */
  BoolFeature USB2SupportEnable;
  /**
      \brief      Selects which bit of the User Output register will be set by
     UserOutputValue.
  */
  ...
  */
  ...
  /**
      \brief      Sets the value of all the bits of the User Output register. It
     is subject to the UserOutputValueAllMask.
  */
  IntegerFeature UserOutputValueAll;
  /**
      \brief      Returns the data of the selected UserSet. The size of the
     UserSet itself is given in the Length element of the feature. The start
     address is stored in the element Address of the feature. The feature is
     only available if the feature UserSetDataEnable is switched on.
  */
  RegisterFeature UserSetData;
  /**
      \brief      Enables the feature UserSetData. If it is switch to off the
     feature UserSetData is not available.
  */
  BoolFeature UserSetDataEnable;
  /**
      \brief      Selects the feature User Set to load and make active by
  ...
  */
  ...
  /**
      \brief      Loads the User Set specified by UserSetSelector to the device
     and makes it active.
  */
  CommandFeature UserSetLoad;
  /**
      \brief      Save the User Set specified by UserSetSelector to the
  ...
  */
  ...
  /**
      \brief      Sets the selector for the Start Address of a single UserSet
     where the UserSet Data can read from.
  */
  ...
  */
  ...
  /**
      \brief      Maximum width of the image (in pixels). The dimension is
     calculated after horizontal binning, decimation or any other function
     changing the horizontal dimension of the image.
  */
  IntegerFeature WidthMax;
  /**
      \brief      Reports the number of discarded action command due to wrong
     action command parameters (DeviceKey, GroupKey, GroupMask).
  */
  ...
  */
  ...
  /**
      \brief      Reports the number of discarded packets due to wrong MAC
     address or wrong IP protocol or wrong UDP port or CRC error.
  */
  IntegerFeature aPacketMACCtrlFramesError;
  /**
      \brief      Reports the number of packets which cannot be received due to
     full receive buffers.
  */
  ...
  */
  ...
  /**
      \brief      Reports the number of discarded resend packets due to wrong
     stream channel index or full resend queue.
  */
  ...
  */
  ...
  /**
      \brief      Angular aperture of the lens as the angular size of the lens
     aperture as seen from the focal point in degree.
  */
  ...
  */
  ...
  /**
      \brief      Buffer for exchanging ASCII data over the serial interface.
     This buffer uses the same memory as boSerialBinaryReadBuffer.
  */
  StringFeature boSerialASCIIReadBuffer;
  /**
      \brief      Buffer for exchanging ASCII data over the serial interface.
     This buffer uses the same memory as boSerialBinaryWriteBuffer.
  */
  StringFeature boSerialASCIIWriteBuffer;
  /**
      \brief      Buffer for exchanging binary data over the serial interface.
     This buffer uses the same memory as boSerialASCIIReadBuffer.
  */
  RegisterFeature boSerialBinaryReadBuffer;
  /**
      \brief      Buffer for exchanging binary data over the serial interface.
     This buffer uses the same memory as boSerialASCIIWriteBuffer.
  */
  RegisterFeature boSerialBinaryWriteBuffer;
  /**
      \brief      When refreshed number of available data bytes for read are
     shown.
  */
  ...
  */
  ...
  /**
      \brief      Result of the serial error detection mechanism. The value is
     reset with each read access.
  */
