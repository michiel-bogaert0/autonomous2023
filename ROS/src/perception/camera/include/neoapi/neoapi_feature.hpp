/* \file neoapi_feature.hpp
 \brief        This file is part of the NeoAPI - It provides the C++ API
 Interface.

 Copyright (c) by Baumer Optronic GmbH. All rights reserved, please see the
 provided license document for full details.
 */
...
/**
    ...
    This class provides an easy way to work with camera features. It provides
   access to the GenICam SFNC features as well as custom features the camera
   might support.

    The Class has a set of methods to get information about and work with a
   feature (such as type, minimum and maximum values), find out if a feature is
   accessible (available/readable/writable) and to read or write features.

    More information about the GenICam SFNC (standard feature naming convention)
   can be found at the [EMVA Website]
    (https://www.emva.org/standards-technology/genicam/genicam-downloads/).

    More information about the features of your specific camera can be found in
   the documentation of your camera available at the member area of the [Baumer
...
public:
  ...
  */
  ...
  /**
      ...
      Valid for the interface types 'IFloat', 'IInteger', 'IEnumeration' and
     'IBoolean'
  ...
  */
  ...
  /**
      \brief     Get the current value of the Feature object as floating-point
     number
  ...
  */
  ...
  /**
      \brief     This function writes a floating-point value to the Feature
     object
  ...
  */
  ...
  /**
      ...
      GenICam features can have different interface (data) types. Depending on
     the interface type, different feature access methods are provided
  ...
  */
  ...
  /**
      \brief      Get the recommended visibility (Beginner/Expert/Guru or
     Invisible) of the Feature object \return     A string representing the
     visibility of the Feature object \exception  FeatureAccessException The
     calling object is not valid
  */
  ...
  */
  ...
  /**
      \brief      Get a value, which recommends the representation type of the
     Feature object in a GUI

      The presentation is only available for the interface types IFloat and
     IInteger.
  ...
  */
  ...
  /**
      \brief      Get the physical unit of the Feature object, only available
     for the types 'IFloat' and 'IInteger' \return     The physical unit of the
     Feature object \exception  FeatureAccessException The calling object is not
     valid
  */
  ...
  /**
      ...
      \return     True if the Feature object is available to work with it,
     otherwise false \exception  FeatureAccessException The calling object is
     not valid
  */
  ...
  */
  ...
  /**
      \brief      Get the smallest allowed value of the Feature object as
     integer
  ...
  */
  ...
  /**
      \brief      Get the allowed step size for the value of the Feature object
     as integer
  ...
  */
  ...
  /**
      \brief      Get the smallest allowed value of the Feature object as a
  ...
  */
  ...
  /**
      \brief      Get the largest allowed value of the Feature object as a
     floating-point number
  ...
  */
  ...
  /**
      ...
      \return     A non-negative number for the precision the double should be
     displayed \exception  FeatureAccessException The calling object is not
     valid
  */
  ...
  */
  ...
  /**
      \brief      Indicates whether the command of the Feature object is still
     executing

      Only valid for the interface type 'ICommand'. Must be supported by the
     camera. Currently no Baumer camera is supporting this

      \return     False if the command of the Feature object is still been
     executed, true if it finished executing \exception  FeatureAccessException
     The calling object is not valid
  */
  ...
  */
  ...
  /**
      ...
      A selector is a possibility to define feature dependencies. The current
     value of a selector Feature has an impact on the value of another Feature
     object. Valid for the interface types 'IInteger' and 'IEnumeration'
  ...
  */
  ...
  /**
      \brief      Get the length in bytes of the memory pointed to by the
     Feature object

      Only valid for the interface type 'IRegister'

      \return     The length in bytes of the memory pointed to by the Feature
     object \exception  FeatureAccessException The calling object is not valid
  */
  ...
  */
  ...
  /**
      \brief      Reads the memory pointed to by the Feature object and writes
     it into the provided buffer

      Only valid for the interface type 'IRegister'

      \param[in]  buffer The destination buffer into which the read data is
     copied \param[in]  length The size of the destination buffer. The method
     GetRegisterLength provides the necessary size \return     The Feature
     object \exception  FeatureAccessException The calling object is not valid
  */
  ...
  /**
      ...
      \param[in]  length The size of the destination buffer. The method
     GetRegisterLength provides the necessary size \return     The Feature
     object \exception  FeatureAccessException The calling object is not valid
  */
...
public:
  ...
  */
  ...
  /**
      ...
      // or (every time the feature name is passed, a search on the internal
     list takes place.) if (camera.HasFeature("SpecialFeature")) {    // check
     if feature exists camera.SetFeature("SpecialFeature", 1);   // set feature
      }
      \endcode
  */
...
/**
    ...
    \brief      Base Feature class providing the interface to be used
   independent of Feature data-type
*/
...
public:
  ...
  */
  ...
  /**
      ...
      Depending on the GenICam interface type, different feature access methods
     are provided. The available interface types are defined in header file
     bgapi2_def.h. See definitions BGAPI2_NODEINTERFACE_xxx
...
public:
  ...
  */
  ...
  /**
      \brief      Get the physical unit of the Feature object. Only available
     for the interface types 'IFloat' and 'IInteger' \return     The physical
     unit of the Feature object \exception  FeatureAccessException The calling
     object is not valid
  */
  virtual NeoString GetUnit() const;
  ...
  /**
     ...
     IInteger.
      ...
      \return     The recommended value for the representation of the Feature
     object in a GUI \exception  FeatureAccessException The calling object is
     not valid
  */
  virtual NeoString GetRepresentation() const;
};
  ...
  */
  ...
  /**
     ...
     it into the provided buffer
      ...
      \param[in]  buffer The destination buffer into which the read data is
     copied \param[in]  length The size of the destination buffer. The method
     GetRegisterLength provides the necessary size \return     The
     RegisterFeature object \exception  FeatureAccessException The calling
     object is not valid
  */
