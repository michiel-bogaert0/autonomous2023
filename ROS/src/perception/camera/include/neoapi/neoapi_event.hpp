...
/**
    ...
    This class provides an easy way to work with events. It provides access to
   camera events as well as plug and play events.

    The Class has a set of methods to get information about an event.

    More information about the events of your specific camera can be found in
...
public:
  ...
  */
  ...
  /**
      ...
      \return     The name of the Feature object, empty if the event does not
     contain any data.
  */
  ...
  /**
      ...
      \return     The timestamp of the Feature object, zero if the event does
  ...
  */
  ...
  /**
      ...
      \return     The id of the Feature object, zero if the event does not
     contain any data.
  */
  ...
  /**
      ...
      \return     The id of the camera, empty if the event does not contain any
     data.
  */
