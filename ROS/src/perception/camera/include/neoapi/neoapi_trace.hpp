...
/**
    \ingroup    All
    \brief      Trace class which offers the possibility to enable trace for
   different targets
*/
...
public:
  ...
  */
  void Info(const NeoString &msg, const NeoString &mod, const NeoString &fct,
            void *object = nullptr) const;
  ...
  */
  ...
  /**
      ...
      \param[in]  object The object to trace.
  */
  void Warning(const NeoString &msg, const NeoString &mod, const NeoString &fct,
               void *object = nullptr) const;
  ...
  */
  ...
  /**
      ...
      \param[in]  object The object to trace.
  */
  void Error(const NeoString &msg, const NeoString &mod, const NeoString &fct,
             void *object = nullptr) const;
  ...
  */
  ...
  /**
      ...
      \param[in]  callback The LogCallback method of the given object will be
     called for every trace message.
  */
