...
class OdriveConverter:
    def __init__(self, bus=None):
        ...
        self.power = rospy.Publisher("/output/power", BatteryState, queue_size=10)
    ...
    def handle_power_msg(self, msg: Frame, cmd_id: int):
    ...
    def handle_vel_msg(self, msg: Frame, axis_id: int, cmd_id: int) -> None:
