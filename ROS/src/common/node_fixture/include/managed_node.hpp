...
namespace node_fixture
{
  ...
  public:
     ...
     * - std::vector<diagnostic_msgs::KeyValue> values: the values of the health status
     */
    void setHealthStatus(int level, const std::string &message, const std::vector<diagnostic_msgs::KeyValue> &values);
