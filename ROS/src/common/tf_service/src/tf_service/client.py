...
class BufferClient(tf2_ros.BufferInterface):
    ...
    def lookup_transform(
        ...
        """
        return self.client.lookup_transform(target_frame, source_frame, time, timeout)
    ...
    def lookup_transform_full(
        ...
        :rtype: :class:`geometry_msgs.msg.TransformStamped`
        """
        return self.client.lookup_transform(
    ...
    def can_transform(
        ...
        :rtype: bool
        """
        return self.client.can_transform(target_frame, source_frame, time, timeout, "")
    ...
    def can_transform_full(
        ...
        :rtype: bool
        """
        return self.client.can_transform(
            target_frame,
            target_time,
            source_frame,
            source_time,
