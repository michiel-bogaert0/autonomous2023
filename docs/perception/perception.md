...
* take in data from a specific source
* detect cones
* detect keypoints

You can also specify whether you want to enable CUDA support and visualisation to the `/vis/perception` topic.
...
## Cone detection
The cone detection is a standard YOLOv5 network.
